...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventPatternObservable".FromEventPatternObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventPatternObservable.d.ts:87
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="FromEventPatternObservable")
public class FromEventPatternObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public FromEventPatternObservable(Function1<Function, Object> addHandler, Action2<Function, Object> removeHandler, Function1<Object, T> selector){
    }
    ...
    */
    /** 
      ...
      * called when the Subscription is unsubscribed.): any} addHandler A function that takes
      * a `handler` function as argument and attaches it somehow to the actual
      * source of events., signal?: any): void} [removeHandler] An optional function that
      * takes a `handler` function as argument and removes it in case it was
      * previously attached using `addHandler`. if addHandler returns signal to teardown when remove,
      * removeHandler function will forward it.): T} [selector] An optional function to
      * post-process results. It takes the arguments from the event handler and
      * should return a single value.
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventPatternObservable.d.ts:2352
     */
    @JsMethod(namespace="rxjs.FromEventPatternObservable", name = "create")
    public static native <T> FromEventPatternObservable<T> create(Function1<Function, Object> addHandler, Action2<Function, Object> removeHandler /* optional */, Function1<Object, T> selector /* optional */);
    ...
    */
    ...
    public native Object getAddHandler();

    @JsProperty( name = "addHandler")
    public native void setAddHandler( Object value );
    ...
    public native Object getRemoveHandler();

    @JsProperty( name = "removeHandler")
    public native void setRemoveHandler( Object value );
    ...
    */
    /** 
      * Std Signature : S(_callAddHandler,3,,P(d3),P(d3))
      * TE Signature : S(_callAddHandler,P(d3),P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventPatternObservable.d.ts@2802
     */
    public native Object _callAddHandler(Object handler, Object errorSubscriber);
    /** 
      * Std Signature : S(_callSelector,3,,P(d3),P(d3))
      * TE Signature : S(_callSelector,P(d3),P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventPatternObservable.d.ts@2757
     */
    public native Object _callSelector(Object subscriber, Object args);
    /** 
