...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/observable/SubscribeOnObservable".SubscribeOnObservable
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/observable/SubscribeOnObservable.d.ts:318
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="SubscribeOnObservable")
public class SubscribeOnObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public SubscribeOnObservable(Observable<T> source, Number delayTime, IScheduler scheduler){
    }
    ...
    */
    /** 
      * source : apis/angular4-api/tsd/rxjs/observable/SubscribeOnObservable.d.ts:561
     */
    @JsMethod(namespace="rxjs.SubscribeOnObservable", name = "create")
    public static native <T> Observable<T> create(Observable<T> source, Number delay /* optional */, IScheduler scheduler /* optional */);
    /** 
      * source : apis/angular4-api/tsd/rxjs/observable/SubscribeOnObservable.d.ts:661
     */
    @JsMethod(namespace="rxjs.SubscribeOnObservable", name = "dispatch")
    public static native <T> Subscription dispatch(DispatchArg<T> arg);
    ...
    */
    ...
    public native Object getDelayTime();

    @JsProperty( name = "delayTime")
    public native void setDelayTime( Object value );
