...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/observable/IteratorObservable".IteratorObservable
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/observable/IteratorObservable.d.ts:179
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="IteratorObservable")
public class IteratorObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public IteratorObservable(Object iterator, IScheduler scheduler){
    }
    ...
    */
    /** 
      * source : apis/angular4-api/tsd/rxjs/observable/IteratorObservable.d.ts:391
     */
    @JsMethod(namespace="rxjs.IteratorObservable", name = "create")
    public static native <T> IteratorObservable<T> create(Object iterator, IScheduler scheduler /* optional */);
    /** 
      * source : apis/angular4-api/tsd/rxjs/observable/IteratorObservable.d.ts:475
     */
    @JsMethod(namespace="rxjs.IteratorObservable", name = "dispatch")
    ...
    */
    ...
    public native Object getIterator();

    @JsProperty( name = "iterator")
    public native void setIterator( Object value );
