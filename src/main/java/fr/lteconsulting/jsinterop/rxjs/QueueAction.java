...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/scheduler/QueueAction".QueueAction
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/scheduler/QueueAction.d.ts:143
  * 1 constructors
...
public class QueueAction<T> extends AsyncAction<T>
{
    ...
    /*
        Constructors
    */
    public QueueAction(QueueScheduler scheduler, Action1<T> work){
        super(null, null);
    }
    ...
    */
    ...
    /** 
      * Std Signature : S(requestAsyncId,3,,P(d717))
      * TE Signature : S(requestAsyncId,P(d717))
      * 
     */
    public native Object requestAsyncId(QueueScheduler scheduler);
    /** 
      * Std Signature : S(requestAsyncId,3,,P(d717),P(d3))
      * TE Signature : S(requestAsyncId,P(d717),P(d3))
      * 
     */
    public native Object requestAsyncId(QueueScheduler scheduler, Object id /* optional */);
    /** 
      * Std Signature : S(requestAsyncId,3,,P(d717),P(d3),P(d2))
      * TE Signature : S(requestAsyncId,P(d717),P(d3),P(d2))
      * 
     */
    /** 
      * apis/angular4-api/tsd/rxjs/scheduler/QueueAction.d.ts@596
     */
    public native Object requestAsyncId(QueueScheduler scheduler, Object id /* optional */, Number delay /* optional */);
    /** 
