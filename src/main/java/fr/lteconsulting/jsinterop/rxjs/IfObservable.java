...
import fr.lteconsulting.jsinterop.UnionOfPromiseLikeOfRAndSubscribableOfRAndVoid;
import fr.lteconsulting.jsinterop.UnionOfPromiseLikeOfTAndSubscribableOfTAndVoid;
...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/IfObservable".IfObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/IfObservable.d.ts:159
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="IfObservable")
public class IfObservable<T, R> implements Observable<T>
{

    /*
        Constructors
    */
    public IfObservable(Function<UnionOfBooleanAndVoid> condition, UnionOfPromiseLikeOfTAndSubscribableOfTAndVoid<T> thenSource, UnionOfPromiseLikeOfRAndSubscribableOfRAndVoid<R> elseSource){
    }
    ...
    */
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/IfObservable.d.ts:394
     */
    @JsMethod(namespace="rxjs.IfObservable", name = "create")
    public static native <T, R> Observable<UnionOfRAndT<T, R>> create(Function<UnionOfBooleanAndVoid> condition, UnionOfPromiseLikeOfTAndSubscribableOfTAndVoid<T> thenSource /* optional */, UnionOfPromiseLikeOfRAndSubscribableOfRAndVoid<R> elseSource /* optional */);
    ...
    */
    ...
    public native Object getElseSource();

    @JsProperty( name = "elseSource")
    public native void setElseSource( Object value );
    ...
    public native Object getThenSource();

    @JsProperty( name = "thenSource")
    public native void setThenSource( Object value );
