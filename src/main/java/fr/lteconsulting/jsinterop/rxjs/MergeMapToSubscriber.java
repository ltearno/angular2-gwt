...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/mergeMapTo".MergeMapToSubscriber
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/mergeMapTo.d.ts:1028
  * 1 constructors
...
public class MergeMapToSubscriber<T, I, R> extends OuterSubscriber<T, I>
{
    ...
    /*
        Constructors
    */
    public MergeMapToSubscriber(Subscriber<R> destination, ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I> ish, Function4<T, I, Number, Number, R> resultSelector, Number concurrent){
    ...
    */
    ...
    /** 
      * Std Signature : S(_innerSub,3,,P(d3),P(d3),P(d3),P(d3),P(d3))
      * TE Signature : S(_innerSub,P(d3),P(d3),P(d3),P(d3),P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/mergeMapTo.d.ts@1594
     */
    public native Object _innerSub(Object ish, Object destination, Object resultSelector, Object value, Object index);
    /** 
     ...
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/mergeMapTo.d.ts@1933
     */
    public native void notifyComplete(Subscription innerSub);
    /** 
      * Std Signature : S(notifyError,429,,P(d3))
      * TE Signature : S(notifyError,P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/mergeMapTo.d.ts@1900
     */
    ...
    /** 
      * Std Signature : S(trySelectResult,3,,P(d3),P(d3),P(d3),P(d3))
      * TE Signature : S(trySelectResult,P(d3),P(d3),P(d3),P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/mergeMapTo.d.ts@1823
     */
    public native Object trySelectResult(Object outerValue, Object innerValue, Object outerIndex, Object innerIndex);
    /** 
