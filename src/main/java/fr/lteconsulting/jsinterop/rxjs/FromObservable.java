...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromObservable".FromObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromObservable.d.ts:147
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="FromObservable")
public class FromObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public FromObservable(ObservableInput_UnionOfArrayLikeOfTAndPromiseLikeOfTAndSubscribableOfT<T> ish, IScheduler scheduler){
    }
    ...
    */
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromObservable.d.ts:416
     */
    @JsMethod(namespace="rxjs.FromObservable", name = "create")
    public static native <T> Observable<T> create(ObservableInput_UnionOfArrayLikeOfTAndPromiseLikeOfTAndSubscribableOfT<T> ish, IScheduler scheduler /* optional */);
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromObservable.d.ts:416
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromObservable.d.ts:502
     */
    @JsMethod(namespace="rxjs.FromObservable", name = "create")
    public static native <T, R> Observable<R> create(ArrayLike<T> ish, IScheduler scheduler /* optional */);
