...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/RangeObservable".RangeObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/RangeObservable.d.ts:179
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="RangeObservable")
public class RangeObservable implements Observable<Number>
{

    /*
        Constructors
    */
    public RangeObservable(Number start, Number count, IScheduler scheduler){
    }
    ...
    */
    /** 
      ...
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/RangeObservable.d.ts:1594
     */
    @JsMethod(namespace="rxjs.RangeObservable", name = "create")
    public static native Observable<Number> create(Number start /* optional */, Number count /* optional */, IScheduler scheduler /* optional */);
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/RangeObservable.d.ts:1689
     */
    @JsMethod(namespace="rxjs.RangeObservable", name = "dispatch")
    ...
    */
    ...
    public native Object get_count();

    @JsProperty( name = "_count")
    public native void set_count( Object value );
    ...
    public native Object getStart();

    @JsProperty( name = "start")
    public native void setStart( Object value );
