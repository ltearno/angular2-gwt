...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/Subject".Subject
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/Subject.d.ts:428
  * 1 constructors
 */
@JsType(isNative=true, namespace="rxjs", name="Subject")
public class Subject<T> implements Observable<T>, ISubscription
{
    ...
    */
    ...
    @JsProperty(namespace="rxjs.Subject", name="create")
    ...
    */
    ...
    public native Boolean getHasError();

    @JsProperty( name = "hasError")
    public native void setHasError( Boolean value );
    ...
    public Array<Observer<T>> observers;

    @JsProperty( name = "observers")
    public native Array<Observer<T>> getObservers();

    @JsProperty( name = "observers")
    public native void setObservers( Array<Observer<T>> value );
    ...
    public native Object getThrownError();

    @JsProperty( name = "thrownError")
    public native void setThrownError( Object value );
    ...
    */
    ...
    /** 
      * Std Signature : S(asObservable,357<T->,,)
      * TE Signature : S(asObservable,)
      * 
     */
    /** 
      * apis/angular4-api/tsd/rxjs/Subject.d.ts@1004
     */
     ...
     */
    /** 
      * apis/angular4-api/tsd/rxjs/Subject.d.ts@819
     */
     ...
     */
    /** 
      * apis/angular4-api/tsd/rxjs/Subject.d.ts@792
     */
     ...
     */
    /** 
      * apis/angular4-api/tsd/rxjs/Subject.d.ts@765
     */
    public native void next(T value /* optional */);
    /** 
