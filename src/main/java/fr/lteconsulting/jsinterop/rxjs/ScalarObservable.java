...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/observable/ScalarObservable".ScalarObservable
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/observable/ScalarObservable.d.ts:179
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="ScalarObservable")
public class ScalarObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public ScalarObservable(T value, IScheduler scheduler){
    }
    ...
    */
    /** 
      * source : apis/angular4-api/tsd/rxjs/observable/ScalarObservable.d.ts:381
     */
    @JsMethod(namespace="rxjs.ScalarObservable", name = "create")
    public static native <T> ScalarObservable<T> create(T value, IScheduler scheduler /* optional */);
    /** 
      * source : apis/angular4-api/tsd/rxjs/observable/ScalarObservable.d.ts:458
     */
    @JsMethod(namespace="rxjs.ScalarObservable", name = "dispatch")
