...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/ReplaySubject".ReplaySubject
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/ReplaySubject.d.ts:168
  * 1 constructors
 */
...
public class ReplaySubject<T> extends Subject<T>
{
    ...
    /*
        Constructors
    */
    public ReplaySubject(Number bufferSize, Number windowTime, IScheduler scheduler){
    }
    ...
    */
    ...
    public native Object get_bufferSize();

    @JsProperty( name = "_bufferSize")
    public native void set_bufferSize( Object value );

    public Object _events;

    @JsProperty( name = "_events")
    public native Object get_events();

    @JsProperty( name = "_events")
    public native void set_events( Object value );
    ...
    public native Object get_windowTime();

    @JsProperty( name = "_windowTime")
    public native void set_windowTime( Object value );
    ...
    */
    ...
    /** 
      * Std Signature : S(_getNow,2,,)
      * TE Signature : S(_getNow,)
      * 
     */
    /** 
      * apis/angular4-api/tsd/rxjs/ReplaySubject.d.ts@537
     */
    public native Number _getNow();
    /** 
    ...
    /** 
      * Std Signature : S(_trimBufferThenGetEvents,3,,)
      * TE Signature : S(_trimBufferThenGetEvents,)
      * 
     */
    /** 
      * apis/angular4-api/tsd/rxjs/ReplaySubject.d.ts@560
     */
    public native Object _trimBufferThenGetEvents();
    /** 
