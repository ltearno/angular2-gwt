...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/PromiseObservable".PromiseObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/PromiseObservable.d.ts:179
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="PromiseObservable")
public class PromiseObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public PromiseObservable(PromiseLike<T> promise, IScheduler scheduler){
    }
    ...
    */
    /** 
      ...
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/PromiseObservable.d.ts:1592
     */
    @JsMethod(namespace="rxjs.PromiseObservable", name = "create")
    public static native <T> Observable<T> create(PromiseLike<T> promise, IScheduler scheduler /* optional */);
    ...
    */
    ...
    public native Object getPromise();

    @JsProperty( name = "promise")
    public native void setPromise( Object value );
