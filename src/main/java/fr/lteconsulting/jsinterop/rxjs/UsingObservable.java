...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/UsingObservable".UsingObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/UsingObservable.d.ts:182
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="UsingObservable")
public class UsingObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public UsingObservable(Function<UnionOfAnonymousSubscriptionAndVoid> resourceFactory, Function1<AnonymousSubscription, UnionOfPromiseLikeOfTAndSubscribableOfTAndVoid<T>> observableFactory){
    }
    ...
    */
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/UsingObservable.d.ts:406
     */
    @JsMethod(namespace="rxjs.UsingObservable", name = "create")
    public static native <T> Observable<T> create(Function<UnionOfAnonymousSubscriptionAndVoid> resourceFactory, Function1<AnonymousSubscription, UnionOfPromiseLikeOfTAndSubscribableOfTAndVoid<T>> observableFactory);
    ...
    */
    ...
    public native Object getObservableFactory();

    @JsProperty( name = "observableFactory")
    public native void setObservableFactory( Object value );
    ...
    public native Object getResourceFactory();

    @JsProperty( name = "resourceFactory")
    public native void setResourceFactory( Object value );
