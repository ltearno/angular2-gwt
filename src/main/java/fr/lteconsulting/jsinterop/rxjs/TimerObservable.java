...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/TimerObservable".TimerObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/TimerObservable.d.ts:179
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="TimerObservable")
public class TimerObservable implements Observable<Number>
{

    /*
        Constructors
    */
    public TimerObservable(UnionOfDateAndNumber dueTime, UnionOfISchedulerAndNumber period, IScheduler scheduler){
    }
    ...
    */
    /** 
      ...
      * sequence.
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/TimerObservable.d.ts:2342
     */
    @JsMethod(namespace="rxjs.TimerObservable", name = "create")
    public static native Observable<Number> create(UnionOfDateAndNumber initialDelay /* optional */, UnionOfISchedulerAndNumber period /* optional */, IScheduler scheduler /* optional */);
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/TimerObservable.d.ts:2465
     */
    @JsMethod(namespace="rxjs.TimerObservable", name = "dispatch")
    ...
    */
    ...
    public native Object getDueTime();

    @JsProperty( name = "dueTime")
    public native void setDueTime( Object value );
