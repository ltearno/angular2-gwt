...
import fr.lteconsulting.jsinterop.browser.EventListenerOptions_UnionOfObjectAndBoolean;
import fr.lteconsulting.jsinterop.browser.EventTargetLike_UnionOfObjectAndEventTargetAndHTMLCollectionAndNodeList;
...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable".FromEventObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:763
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="FromEventObservable")
public class FromEventObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public FromEventObservable(EventTargetLike_UnionOfObjectAndEventTargetAndHTMLCollectionAndNodeList sourceObj, String eventName, Function1<Object, T> selector, EventListenerOptions_UnionOfObjectAndBoolean options){
    }
    ...
    */
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1020
     */
    @JsMethod(namespace="rxjs.FromEventObservable", name = "create")
    public static native <T> Observable<T> create(EventTargetLike_UnionOfObjectAndEventTargetAndHTMLCollectionAndNodeList target, String eventName);
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1020
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1101
     */
    @JsMethod(namespace="rxjs.FromEventObservable", name = "create")
    public static native <T> Observable<T> create(EventTargetLike_UnionOfObjectAndEventTargetAndHTMLCollectionAndNodeList target, String eventName, Function1<Object, T> selector);
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1020
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1101
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1220
     */
    @JsMethod(namespace="rxjs.FromEventObservable", name = "create")
    public static native <T> Observable<T> create(EventTargetLike_UnionOfObjectAndEventTargetAndHTMLCollectionAndNodeList target, String eventName, EventListenerOptions_UnionOfObjectAndBoolean options);
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1020
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1101
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1220
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1332
     */
    @JsMethod(namespace="rxjs.FromEventObservable", name = "create")
    public static native <T> Observable<T> create(EventTargetLike_UnionOfObjectAndEventTargetAndHTMLCollectionAndNodeList target, String eventName, EventListenerOptions_UnionOfObjectAndBoolean options, Function1<Object, T> selector);
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/FromEventObservable.d.ts:1617
     */
    @JsMethod(namespace="rxjs.FromEventObservable", name = "setupSubscription")
    public static native <T> Object setupSubscription(Object sourceObj, Object eventName, Object handler, Object subscriber, Object options /* optional */);
    ...
    */
    ...
    public native Object getEventName();

    @JsProperty( name = "eventName")
    public native void setEventName( Object value );
    ...
    public native Object getSourceObj();

    @JsProperty( name = "sourceObj")
    public native void setSourceObj( Object value );
