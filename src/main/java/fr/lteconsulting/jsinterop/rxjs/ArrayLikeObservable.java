...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/observable/ArrayLikeObservable".ArrayLikeObservable
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/observable/ArrayLikeObservable.d.ts:179
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="ArrayLikeObservable")
public class ArrayLikeObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public ArrayLikeObservable(ArrayLike<T> arrayLike, IScheduler scheduler){
    }
    ...
    */
    /** 
      * source : apis/angular4-api/tsd/rxjs/observable/ArrayLikeObservable.d.ts:393
     */
    @JsMethod(namespace="rxjs.ArrayLikeObservable", name = "create")
    public static native <T> Observable<T> create(ArrayLike<T> arrayLike, IScheduler scheduler /* optional */);
    /** 
      * source : apis/angular4-api/tsd/rxjs/observable/ArrayLikeObservable.d.ts:479
     */
    @JsMethod(namespace="rxjs.ArrayLikeObservable", name = "dispatch")
    ...
    */
    ...
    public native Object getArrayLike();

    @JsProperty( name = "arrayLike")
    public native void setArrayLike( Object value );
