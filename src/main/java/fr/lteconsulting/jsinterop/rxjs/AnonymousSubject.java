...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/Subject".AnonymousSubject
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/Subject.d.ts:1036
  * 1 constructors
 */
...
public class AnonymousSubject<T> extends Subject<T>
{
    ...
    /*
        Constructors
    */
    public AnonymousSubject(Observer<T> destination, Observable<T> source){
    }
    ...
    */
    ...
    public native Observer<T> getDestination();

    @JsProperty( name = "destination")
    public native void setDestination( Observer<T> value );
