...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/combineLatest".CombineLatestSubscriber
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/combineLatest.d.ts:2982
  * 1 constructors
...
public class CombineLatestSubscriber<T, R> extends OuterSubscriber<T, R>
{
    ...
    /*
        Constructors
    */
    public CombineLatestSubscriber(Subscriber<R> destination, Function1<Object, R> project){
    ...
    */
    ...
    public native Object getObservables();

    @JsProperty( name = "observables")
    public native void setObservables( Object value );
    ...
    public native Object getToRespond();

    @JsProperty( name = "toRespond")
    public native void setToRespond( Object value );
    ...
    */
    ...
    /** 
      * Std Signature : S(_tryProject,3,,P(d3))
      * TE Signature : S(_tryProject,P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/combineLatest.d.ts@3607
     */
    public native Object _tryProject(Object values);
    /** 
    ...
    /** 
      * Std Signature : S(notifyComplete,429,,P(d354<R->))
      * TE Signature : S(notifyComplete,P(d354))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/combineLatest.d.ts@3433
     */
