...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/SubjectSubscription".SubjectSubscription
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/SubjectSubscription.d.ts:122
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="SubjectSubscription")
public class SubjectSubscription<T> implements Subscription
{
    ...
    */
    ...
    @JsProperty( name = "subject")
    public native void setSubject( Subject<T> value );

    public Observer<T> subscriber;

    @JsProperty( name = "subscriber")
    public native Observer<T> getSubscriber();

    @JsProperty( name = "subscriber")
    public native void setSubscriber( Observer<T> value );
