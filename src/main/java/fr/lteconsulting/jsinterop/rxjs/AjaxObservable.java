...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/AjaxObservable".AjaxObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/AjaxObservable.d.ts:1655
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="AjaxObservable")
public class AjaxObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public AjaxObservable(UnionOfAjaxRequestAndString urlOrRequest){
    }
    ...
    */
    /** 
      ...
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/AjaxObservable.d.ts:574
     */
    @JsMethod(namespace="rxjs.AjaxObservable", name = "create")
    public static native <T> Observable<AjaxResponse> create(UnionOfAjaxRequestAndString urlOrRequest);
    ...
    */
    ...
    @JsProperty( name = "request")
    public native void setRequest( Object value );
