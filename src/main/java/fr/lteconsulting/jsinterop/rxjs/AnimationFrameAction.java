...
/** 
  * base type: "apis/angular4-api/tsd/rxjs/scheduler/AnimationFrameAction".AnimationFrameAction
  * flags: 32768
  * declared in: apis/angular4-api/tsd/rxjs/scheduler/AnimationFrameAction.d.ts:113
  * 1 constructors
...
public class AnimationFrameAction<T> extends AsyncAction<T>
{
    ...
    /*
        Constructors
    */
    public AnimationFrameAction(AnimationFrameScheduler scheduler, Action1<T> work){
        super(null, null);
    }
    ...
    */
    ...
    /** 
      * Std Signature : S(recycleAsyncId,3,,P(d715))
      * TE Signature : S(recycleAsyncId,P(d715))
      * 
     */
    public native Object recycleAsyncId(AnimationFrameScheduler scheduler);
    /** 
      * Std Signature : S(recycleAsyncId,3,,P(d715),P(d3))
      * TE Signature : S(recycleAsyncId,P(d715),P(d3))
      * 
     */
    public native Object recycleAsyncId(AnimationFrameScheduler scheduler, Object id /* optional */);
    /** 
      * Std Signature : S(recycleAsyncId,3,,P(d715),P(d3),P(d2))
      * TE Signature : S(recycleAsyncId,P(d715),P(d3),P(d2))
      * 
     */
    /** 
      * apis/angular4-api/tsd/rxjs/scheduler/AnimationFrameAction.d.ts@610
     */
    public native Object recycleAsyncId(AnimationFrameScheduler scheduler, Object id /* optional */, Number delay /* optional */);
    /** 
    ...
    /** 
      * Std Signature : S(requestAsyncId,3,,P(d715))
      * TE Signature : S(requestAsyncId,P(d715))
      * 
     */
    public native Object requestAsyncId(AnimationFrameScheduler scheduler);
    /** 
      * Std Signature : S(requestAsyncId,3,,P(d715),P(d3))
      * TE Signature : S(requestAsyncId,P(d715),P(d3))
      * 
     */
    public native Object requestAsyncId(AnimationFrameScheduler scheduler, Object id /* optional */);
    /** 
      * Std Signature : S(requestAsyncId,3,,P(d715),P(d3),P(d2))
      * TE Signature : S(requestAsyncId,P(d715),P(d3),P(d2))
      * 
     */
    /** 
      * apis/angular4-api/tsd/rxjs/scheduler/AnimationFrameAction.d.ts@513
     */
    public native Object requestAsyncId(AnimationFrameScheduler scheduler, Object id /* optional */, Number delay /* optional */);
    /** 
