...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/ConnectableObservable".ConnectableObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/ConnectableObservable.d.ts:173
  * 1 constructors
 */
@JsType(isNative=true, namespace="rxjs", name="ConnectableObservable")
public class ConnectableObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public ConnectableObservable(Observable<T> source, Function<Subject<T>> subjectFactory){
    }
    ...
    */
    ...
    public native Subscription get_connection();

    @JsProperty( name = "_connection")
    public native void set_connection( Subscription value );

    public Boolean _isComplete;

    @JsProperty( name = "_isComplete")
    public native Boolean get_isComplete();

    @JsProperty( name = "_isComplete")
    public native void set_isComplete( Boolean value );
    ...
    public Number _refCount;

    @JsProperty( name = "_refCount")
    public native Number get_refCount();

    @JsProperty( name = "_refCount")
    public native void set_refCount( Number value );

    public Subject<T> _subject;

    @JsProperty( name = "_subject")
    public native Subject<T> get_subject();

    @JsProperty( name = "_subject")
    public native void set_subject( Subject<T> value );
    ...
    */
    ...
    /** 
      * Std Signature : S(connect,350,,)
      * TE Signature : S(connect,)
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/ConnectableObservable.d.ts@693
     */
    ...
    /** 
      * Std Signature : S(getSubject,359<T->,,)
      * TE Signature : S(getSubject,)
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/ConnectableObservable.d.ts@653
     */
    ...
    /** 
      * Std Signature : S(refCount,357<T->,,)
      * TE Signature : S(refCount,)
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/ConnectableObservable.d.ts@722
     */
    ...
    /** 
      * Std Signature : S(subjectFactory,359<T->,,)
      * TE Signature : S(subjectFactory,)
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/ConnectableObservable.d.ts@354
     */
    public native Subject<T> subjectFactory();
    /** 
