...
public interface Observable<T> extends Subscribable<T>
{
    ...
    */
    ...
    AnonymousType922 getOnErrorResumeNext();

    @JsProperty( name = "onErrorResumeNext")
    void setOnErrorResumeNext( AnonymousType922 value );
    ...
    */
     ...
     */
    <R> Observable<UnionOfRAndT<T, R>> _catch(Function2<Object, Observable<T>, ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R>> selector);
    /** 
      * Std Signature : S(_do,357<T->,,P(d351<T->))
      * TE Signature : S(_do,P(d351))
      * 
     */
    Observable<T> _do(CompletionObserver<T> observer);
    /** 
      * Std Signature : S(_do,357<T->,,P(d352<T->))
      * TE Signature : S(_do,P(d352))
      * 
     */
    Observable<T> _do(ErrorObserver<T> observer);
    /** 
      * Std Signature : S(_do,357<T->,,P(d353<T->))
      * TE Signature : S(_do,P(d353))
      * 
     */
    Observable<T> _do(NextObserver<T> observer);
    /** 
      * Std Signature : S(_do,357<T->,,P(dFP1--S(?,429,,P(d3))------)<T->))
      * TE Signature : S(_do,P(dF--S(?,P(d3))------)))
      * 
     */
    Observable<T> _do(Action1<T> next);
    /** 
      * Std Signature : S(_do,357<T->,,P(dFP1--S(?,429,,P(d3))------)<T->),P(dFP1--S(?,429,,P(d3))------)<3>))
      * TE Signature : S(_do,P(dF--S(?,P(d3))------)),P(dF--S(?,P(d3))------)))
      * 
     */
    Observable<T> _do(Action1<T> next, Action1<Object> error /* optional */);
    /** 
     ...
     */
    Observable<T> _do(Action1<T> next, Action1<Object> error /* optional */, Action complete /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Observable<T> _do(PartialObserver_UnionOfCompletionObserverOfTAndErrorObserverOfTAndNextObserverOfT<T> observer);
    /** 
     ...
     */
    Observable<T> _finally(Action callback);
    /** 
     ...
     */
    TeardownLogic_UnionOfAnonymousSubscriptionAndFunctionAndVoid _subscribe(Subscriber<Object> subscriber);
    /** 
     ...
     */
    TeardownLogic_UnionOfAnonymousSubscriptionAndFunctionAndVoid _trySubscribe(Subscriber<T> sink);
    /** 
     ...
     */
    Observable<T> audit(Function1<T, SubscribableOrPromise_UnionOfPromiseLikeOfObjectAndSubscribableOfObject> durationSelector);
    /** 
      * Std Signature : S(auditTime,357<T->,,P(d2))
      * TE Signature : S(auditTime,P(d2))
      * 
     */
    Observable<T> auditTime(Number duration);
    /** 
     ...
     */
    Observable<T> auditTime(Number duration, IScheduler scheduler /* optional */);
    /** 
     ...
     */
    Observable<Array<T>> buffer(Observable<Object> closingNotifier);
    /** 
      * Std Signature : S(bufferCount,357<7<T->>,,P(d2))
      * TE Signature : S(bufferCount,P(d2))
      * 
     */
    Observable<Array<T>> bufferCount(Number bufferSize);
    /** 
     ...
     */
    Observable<Array<T>> bufferCount(Number bufferSize, Number startBufferEvery /* optional */);
    /** 
      * Std Signature : S(bufferTime,357<7<T->>,,P(d2))
      * TE Signature : S(bufferTime,P(d2))
      * 
     */
    Observable<Array<T>> bufferTime(Number bufferTimeSpan);
    /** 
      * Std Signature : S(bufferTime,357<7<T->>,,P(d2),P(d2))
      * TE Signature : S(bufferTime,P(d2),P(d2))
      * 
     */
    Observable<Array<T>> bufferTime(Number bufferTimeSpan, Number bufferCreationInterval);
    /** 
      * Std Signature : S(bufferTime,357<7<T->>,,P(d2),P(d2),P(d2))
      * TE Signature : S(bufferTime,P(d2),P(d2),P(d2))
      * 
     */
    Observable<Array<T>> bufferTime(Number bufferTimeSpan, Number bufferCreationInterval, Number maxBufferSize);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    Observable<Array<T>> bufferTime(Number bufferTimeSpan, Number bufferCreationInterval, Number maxBufferSize, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Observable<Array<T>> bufferTime(Number bufferTimeSpan, Number bufferCreationInterval, IScheduler scheduler /* optional */);
    /** 
     ...
     */
    Observable<Array<T>> bufferTime(Number bufferTimeSpan, IScheduler scheduler /* optional */);
    /** 
      ...
      * 
     */
    <O> Observable<Array<T>> bufferToggle(PromiseLike<O> openings, Function1<O, SubscribableOrPromise_UnionOfPromiseLikeOfObjectAndSubscribableOfObject> closingSelector);
    /** 
      ...
      * 
     */
    <O> Observable<Array<T>> bufferToggle(Subscribable<O> openings, Function1<O, SubscribableOrPromise_UnionOfPromiseLikeOfObjectAndSubscribableOfObject> closingSelector);
    /** 
     ...
     */
    <O> Observable<Array<T>> bufferToggle(SubscribableOrPromise_UnionOfPromiseLikeOfOAndSubscribableOfO<O> openings, Function1<O, SubscribableOrPromise_UnionOfPromiseLikeOfObjectAndSubscribableOfObject> closingSelector);
    /** 
     ...
     */
    Observable<Array<T>> bufferWhen(Function<Observable<Object>> closingSelector);
    /** 
     ...
     */
    @JsMethod(name = "catch")
    <R> Observable<UnionOfRAndT<T, R>> catch_(Function2<Object, Observable<T>, ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R>> selector);
    /** 
      * Std Signature : S(combineAll,357<R->,R-,)
      * TE Signature : S(combineAll,)
      * 
     */
    <R> Observable<R> combineAll();
    /** 
    ...
    /** 
      ...
      * VERSION 11
     */
    <R> Observable<R> combineLatest(UnionOfFunction1OfTAndRAndArrayLikeOfTAndPromiseLikeOfTAndSubscribableOfT<T, R>... observables);
    /** 
      * Std Signature : S(combineLatest,357<25<T-,T2->>,T2-,P(d16<T2->))
      * TE Signature : S(combineLatest,P(d16))
      * 
     */
    <T2> Observable<Tuple<T, T2>> combineLatest(PromiseLike<T2> v2);
    /** 
      ...
      * 
     */
    <T2, R> Observable<R> combineLatest(PromiseLike<T2> v2, Function2<T, T2, R> project);
    /** 
      * Std Signature : S(combineLatest,357<25<T-,T2->>,T2-,P(d358<T2->))
      * TE Signature : S(combineLatest,P(d358))
      * 
     */
    <T2> Observable<Tuple<T, T2>> combineLatest(Subscribable<T2> v2);
    /** 
      ...
      * 
     */
    <T2, R> Observable<R> combineLatest(Subscribable<T2> v2, Function2<T, T2, R> project);
    /** 
      * Std Signature : S(combineLatest,357<25<T-,T2->>,T2-,P(d5<T2->))
      * TE Signature : S(combineLatest,P(d5))
      * 
     */
    <T2> Observable<Tuple<T, T2>> combineLatest(ArrayLike<T2> v2);
    /** 
      ...
      * 
     */
    <T2, R> Observable<R> combineLatest(ArrayLike<T2> v2, Function2<T, T2, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 12
     */
    <R> Observable<Array<T>> combineLatest(Array<ObservableInput_UnionOfArrayLikeOfTAndPromiseLikeOfTAndSubscribableOfT<T>> array);
    /** 
    ...
    /** 
      ...
      * VERSION 13
     */
    <TOther, R> Observable<R> combineLatest(Array<ObservableInput_UnionOfArrayLikeOfTOtherAndPromiseLikeOfTOtherAndSubscribableOfTOther<TOther>> array, Function2<T, TOther, R> project);
    /** 
      * Std Signature : S(combineLatest,357<R->,R-,P(dFP1-,R--S(?,4,,P(d3))------)<T-,R->))
      * TE Signature : S(combineLatest,P(dF--S(?,P(d3))------)))
      * 
     ...
     */
    <R> Observable<R> combineLatest(Function1<T, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 6
     */
    <T2> Observable<Tuple<T, T2>> combineLatest(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <T2, R> Observable<R> combineLatest(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, Function2<T, T2, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 7
     */
    <T2, T3> Observable<TupleOf3<T, T2, T3>> combineLatest(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    <T2, T3, R> Observable<R> combineLatest(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, Function3<T, T2, T3, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 8
     */
    <T2, T3, T4> Observable<TupleOf4<T, T2, T3, T4>> combineLatest(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4);
    /** 
    ...
    /** 
      ...
      * VERSION 9
     */
    <T2, T3, T4, T5> Observable<TupleOf5<T, T2, T3, T4, T5>> combineLatest(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4, ObservableInput_UnionOfArrayLikeOfT5AndPromiseLikeOfT5AndSubscribableOfT5<T5> v5);
    /** 
    ...
    /** 
      ...
      * VERSION 10
     */
    <T2, T3, T4, T5, T6> Observable<TupleOf6<T, T2, T3, T4, T5, T6>> combineLatest(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4, ObservableInput_UnionOfArrayLikeOfT5AndPromiseLikeOfT5AndSubscribableOfT5<T5> v5, ObservableInput_UnionOfArrayLikeOfT6AndPromiseLikeOfT6AndSubscribableOfT6<T6> v6);
    /** 
    ...
    /** 
      ...
      * VERSION 6
     */
    Observable<T> concat(UnionOfArrayLikeOfTAndISchedulerAndPromiseLikeOfTAndSubscribableOfT<T>... observables);
    /** 
      * Std Signature : S(concat,357<U(T-,T2-T-,T2-)>,T2-,P(d16<T2->))
      * TE Signature : S(concat,P(d16))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> concat(PromiseLike<T2> v2);
    /** 
      * Std Signature : S(concat,357<U(T-,T2-T-,T2-)>,T2-,P(d16<T2->),P(d356))
      * TE Signature : S(concat,P(d16),P(d356))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> concat(PromiseLike<T2> v2, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(concat,357<T->,,P(d356))
      * TE Signature : S(concat,P(d356))
      * 
     ...
     */
    Observable<T> concat(IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(concat,357<U(T-,T2-T-,T2-)>,T2-,P(d358<T2->))
      * TE Signature : S(concat,P(d358))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> concat(Subscribable<T2> v2);
    /** 
      * Std Signature : S(concat,357<U(T-,T2-T-,T2-)>,T2-,P(d358<T2->),P(d356))
      * TE Signature : S(concat,P(d358),P(d356))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> concat(Subscribable<T2> v2, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(concat,357<U(T-,T2-T-,T2-)>,T2-,P(d5<T2->))
      * TE Signature : S(concat,P(d5))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> concat(ArrayLike<T2> v2);
    /** 
      * Std Signature : S(concat,357<U(T-,T2-T-,T2-)>,T2-,P(d5<T2->),P(d356))
      * TE Signature : S(concat,P(d5),P(d356))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> concat(ArrayLike<T2> v2, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(concat,357<U(T-,T2-T-,T2-)>,T2-,P(dU(T2-5<T2->,16<5>,358<5>)))
      * TE Signature : S(concat,P(dU(-5,16,358)))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> concat(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> concat(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, IScheduler scheduler /* optional */);
    /** 
      ...
      * 
     */
    <T2, T3> Observable<UnionOfTAndT2AndT3<T, T2, T3>> concat(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    <T2, T3> Observable<UnionOfTAndT2AndT3<T, T2, T3>> concat(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, IScheduler scheduler /* optional */);
    /** 
      ...
      * 
     */
    <T2, T3, T4> Observable<UnionOfTAndT2AndT3AndT4<T, T2, T3, T4>> concat(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4);
    /** 
    ...
    /** 
      ...
      * 
     */
    <T2, T3, T4, T5> Observable<UnionOfTAndT2AndT3AndT4AndT5<T, T2, T3, T4, T5>> concat(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4, ObservableInput_UnionOfArrayLikeOfT5AndPromiseLikeOfT5AndSubscribableOfT5<T5> v5);
    /** 
     ...
     */
    <R> Observable<R> concatMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R>> project);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <I, R> Observable<R> concatMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I>> project, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      * Std Signature : S(concatMapTo,357<R->,R-,P(d16<R->))
      * TE Signature : S(concatMapTo,P(d16))
      * 
     */
    <R> Observable<R> concatMapTo(PromiseLike<R> observable);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> concatMapTo(PromiseLike<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      * Std Signature : S(concatMapTo,357<R->,R-,P(d358<R->))
      * TE Signature : S(concatMapTo,P(d358))
      * 
     */
    <R> Observable<R> concatMapTo(Subscribable<R> observable);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> concatMapTo(Subscribable<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      * Std Signature : S(concatMapTo,357<R->,R-,P(d5<R->))
      * TE Signature : S(concatMapTo,P(d5))
      * 
     */
    <R> Observable<R> concatMapTo(ArrayLike<R> observable);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> concatMapTo(ArrayLike<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
     ...
     */
    <R> Observable<R> concatMapTo(ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R> observable);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <I, R> Observable<R> concatMapTo(ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
     ...
     */
    Observable<Number> count(Function3<T, Number, Observable<T>, Boolean> predicate /* optional */);
    /** 
     ...
     */
    Observable<T> debounce(Function1<T, SubscribableOrPromise_UnionOfPromiseLikeOfNumberAndSubscribableOfNumber> durationSelector);
    /** 
      * Std Signature : S(debounceTime,357<T->,,P(d2))
      * TE Signature : S(debounceTime,P(d2))
      * 
     */
    Observable<T> debounceTime(Number dueTime);
    /** 
     ...
     */
    Observable<T> debounceTime(Number dueTime, IScheduler scheduler /* optional */);
    /** 
     ...
     */
    Observable<T> delay(UnionOfDateAndNumber delay, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(delayWhen,357<T->,,P(dFP1-,R--S(?,4,,P(d3))------)<T-,357<3>>))
      * TE Signature : S(delayWhen,P(dF--S(?,P(d3))------)))
      * 
     */
    Observable<T> delayWhen(Function1<T, Observable<Object>> delayDurationSelector);
    /** 
     ...
     */
    Observable<T> delayWhen(Function1<T, Observable<Object>> delayDurationSelector, Observable<Object> subscriptionDelay /* optional */);
    /** 
     ...
     */
    Observable<Object> dematerialize();
    /** 
    ...
    /** 
      ...
      * 
     */
    <K> Observable<T> distinct(Function1<T, K> keySelector /* optional */);
    /** 
     ...
     */
    <K> Observable<T> distinct(Function1<T, K> keySelector /* optional */, Observable<Object> flushes /* optional */);
    /** 
     ...
     */
    Observable<T> distinctUntilChanged(Function2<T, T, Boolean> compare /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <K> Observable<T> distinctUntilChanged(Function2<K, K, Boolean> compare, Function1<T, K> keySelector);
    /** 
     ...
     */
    Observable<T> distinctUntilKeyChanged(String key);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <K> Observable<T> distinctUntilKeyChanged(String key, Function2<K, K, Boolean> compare);
    /** 
     ...
     */
    @JsMethod(name = "do")
    Observable<T> do_(CompletionObserver<T> observer);
    /** 
     ...
     */
    @JsMethod(name = "do")
    Observable<T> do_(ErrorObserver<T> observer);
    /** 
     ...
     */
    @JsMethod(name = "do")
    Observable<T> do_(NextObserver<T> observer);
    /** 
     ...
     */
    @JsMethod(name = "do")
    Observable<T> do_(Action1<T> next);
    /** 
     ...
     */
    @JsMethod(name = "do")
    Observable<T> do_(Action1<T> next, Action1<Object> error /* optional */);
    /** 
     ...
     */
    @JsMethod(name = "do")
    Observable<T> do_(Action1<T> next, Action1<Object> error /* optional */, Action complete /* optional */);
    /** 
     ...
     */
    @JsMethod(name = "do")
    Observable<T> do_(PartialObserver_UnionOfCompletionObserverOfTAndErrorObserverOfTAndNextObserverOfT<T> observer);
    /** 
     ...
     */
    Observable<T> elementAt(Number index, T defaultValue /* optional */);
    /** 
     ...
     */
    Observable<Boolean> every(Function3<T, Number, Observable<T>, Boolean> predicate);
    /** 
     ...
     */
    <R> Observable<R> exhaustMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R>> project);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <I, R> Observable<R> exhaustMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I>> project, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      * Std Signature : S(expand,357<T->,,P(dFP1-,P2-,R--S(?,5,,P(d3),P(d4))------)<T-,2,357<6>>))
      * TE Signature : S(expand,P(dF--S(?,P(d3),P(d4))------)))
      * 
     */
    Observable<T> expand(Function2<T, Number, Observable<T>> project);
    /** 
      * Std Signature : S(expand,357<T->,,P(dFP1-,P2-,R--S(?,5,,P(d3),P(d4))------)<T-,2,357<6>>),P(d2))
      * TE Signature : S(expand,P(dF--S(?,P(d3),P(d4))------)),P(d2))
      * 
     */
    Observable<T> expand(Function2<T, Number, Observable<T>> project, Number concurrent /* optional */);
    /** 
     ...
     */
    Observable<T> expand(Function2<T, Number, Observable<T>> project, Number concurrent /* optional */, IScheduler scheduler /* optional */);
    /** 
     ...
     */
    <S> Observable<S> filter(Function2<T, Number, Boolean> predicate);
    /** 
    ...
    Observable<T> finally_(Action callback);
    /** 
     ...
     */
    <S> Observable<S> find(Function2<T, Number, Boolean> predicate);
    /** 
     ...
     */
    Observable<Number> findIndex(Function3<T, Number, Observable<T>, Boolean> predicate);
    /** 
     ...
     */
    <S> Observable<S> first(Function3<T, Number, Observable<T>, Boolean> predicate);
    /** 
      ...
      * 
     */
    <S> Observable<S> first(Function3<T, Number, Observable<T>, Boolean> predicate, Void resultSelector);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    <S> Observable<S> first(Function3<T, Number, Observable<T>, Boolean> predicate, Void resultSelector, S defaultValue /* optional */);
    /** 
      ...
      * 
     */
    <R> Observable<R> first(Function3<T, Number, Observable<T>, Boolean> predicate, Function2<T, Number, R> resultSelector /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 4
     */
    <R> Observable<R> first(Function3<T, Number, Observable<T>, Boolean> predicate, Function2<T, Number, R> resultSelector /* optional */, R defaultValue /* optional */);
    /** 
      ...
      * 
     */
    <R> Observable<R> flatMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R>> project);
    /** 
     ...
     */
    <R> Observable<R> flatMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R>> project, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> flatMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I>> project, Function4<T, I, Number, Number, R> resultSelector);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <I, R> Observable<R> flatMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I>> project, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(flatMapTo,357<R->,R-,P(d16<R->))
      * TE Signature : S(flatMapTo,P(d16))
      * 
     */
    <R> Observable<R> flatMapTo(PromiseLike<R> observable);
    /** 
      * Std Signature : S(flatMapTo,357<R->,R-,P(d16<R->),P(d2))
      * TE Signature : S(flatMapTo,P(d16),P(d2))
      * 
     */
    <R> Observable<R> flatMapTo(PromiseLike<R> observable, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> flatMapTo(PromiseLike<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> flatMapTo(PromiseLike<I> observable, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(flatMapTo,357<R->,R-,P(d358<R->))
      * TE Signature : S(flatMapTo,P(d358))
      * 
     */
    <R> Observable<R> flatMapTo(Subscribable<R> observable);
    /** 
      * Std Signature : S(flatMapTo,357<R->,R-,P(d358<R->),P(d2))
      * TE Signature : S(flatMapTo,P(d358),P(d2))
      * 
     */
    <R> Observable<R> flatMapTo(Subscribable<R> observable, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> flatMapTo(Subscribable<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> flatMapTo(Subscribable<I> observable, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(flatMapTo,357<R->,R-,P(d5<R->))
      * TE Signature : S(flatMapTo,P(d5))
      * 
     */
    <R> Observable<R> flatMapTo(ArrayLike<R> observable);
    /** 
      * Std Signature : S(flatMapTo,357<R->,R-,P(d5<R->),P(d2))
      * TE Signature : S(flatMapTo,P(d5),P(d2))
      * 
     */
    <R> Observable<R> flatMapTo(ArrayLike<R> observable, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> flatMapTo(ArrayLike<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> flatMapTo(ArrayLike<I> observable, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(flatMapTo,357<R->,R-,P(dU(R-5<R->,16<5>,358<5>)))
      * TE Signature : S(flatMapTo,P(dU(-5,16,358)))
      * 
     */
    <R> Observable<R> flatMapTo(ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R> observable);
    /** 
     ...
     */
    <R> Observable<R> flatMapTo(ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R> observable, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> flatMapTo(ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <I, R> Observable<R> flatMapTo(ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I> observable, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(forEach,88<349>,,P(dFP1--S(?,429,,P(d3))------)<T->))
      * TE Signature : S(forEach,P(dF--S(?,P(d3))------)))
      * 
     */
    Promise<Void> forEach(Action1<T> next);
    /** 
     ...
     */
    Promise<Void> forEach(Action1<T> next, Object PromiseCtor /* optional */);
    /** 
     ...
     */
    <K> Observable<GroupedObservable<K, T>> groupBy(Function1<T, K> keySelector);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <K> Observable<GroupedObservable<K, T>> groupBy(Function1<T, K> keySelector, Void elementSelector, Function1<GroupedObservable<K, T>, Observable<Object>> durationSelector);
    /** 
      ...
      * 
     */
    <K, R> Observable<GroupedObservable<K, R>> groupBy(Function1<T, K> keySelector, Function1<T, R> elementSelector /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    <K, R> Observable<GroupedObservable<K, R>> groupBy(Function1<T, K> keySelector, Function1<T, R> elementSelector /* optional */, Function1<GroupedObservable<K, R>, Observable<Object>> durationSelector /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 3
     */
    <K, R> Observable<GroupedObservable<K, R>> groupBy(Function1<T, K> keySelector, Function1<T, R> elementSelector /* optional */, Function1<GroupedObservable<K, R>, Observable<Object>> durationSelector /* optional */, Function<Subject<R>> subjectSelector /* optional */);
    /** 
     ...
     */
    <S> Observable<S> last(Function3<T, Number, Observable<T>, Boolean> predicate);
    /** 
      ...
      * 
     */
    <S> Observable<S> last(Function3<T, Number, Observable<T>, Boolean> predicate, Void resultSelector);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    <S> Observable<S> last(Function3<T, Number, Observable<T>, Boolean> predicate, Void resultSelector, S defaultValue /* optional */);
    /** 
      ...
      * 
     */
    <R> Observable<R> last(Function3<T, Number, Observable<T>, Boolean> predicate, Function2<T, Number, R> resultSelector /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 4
     */
    <R> Observable<R> last(Function3<T, Number, Observable<T>, Boolean> predicate, Function2<T, Number, R> resultSelector /* optional */, R defaultValue /* optional */);
    /** 
     ...
     */
    <R> Observable<R> let(Function1<Observable<T>, Observable<R>> func);
    /** 
    ...
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/let.d.ts@130
     */
    <R> Observable<R> letBind(Function1<Observable<T>, Observable<R>> func);
    /** 
     ...
     */
    <R> Observable<R> map(Function2<T, Number, R> project);
    /** 
     ...
     */
    Observable<T> max(Function2<T, T, Number> comparer /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 12
     */
    Observable<T> merge(UnionOfArrayLikeOfTAndISchedulerAndNumberAndPromiseLikeOfTAndSubscribableOfT<T>... observables);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d16<T2->))
      * TE Signature : S(merge,P(d16))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(PromiseLike<T2> v2);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d16<T2->),P(d2))
      * TE Signature : S(merge,P(d16),P(d2))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(PromiseLike<T2> v2, Number concurrent /* optional */);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d16<T2->),P(d2),P(d356))
      * TE Signature : S(merge,P(d16),P(d2),P(d356))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(PromiseLike<T2> v2, Number concurrent /* optional */, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d16<T2->),P(d356))
      * TE Signature : S(merge,P(d16),P(d356))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(PromiseLike<T2> v2, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(merge,357<T->,,P(d2))
      * TE Signature : S(merge,P(d2))
      * 
     */
    Observable<T> merge(Number concurrent /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Observable<T> merge(Number concurrent /* optional */, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(merge,357<T->,,P(d356))
      * TE Signature : S(merge,P(d356))
      * 
     ...
     */
    Observable<T> merge(IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d358<T2->))
      * TE Signature : S(merge,P(d358))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(Subscribable<T2> v2);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d358<T2->),P(d2))
      * TE Signature : S(merge,P(d358),P(d2))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(Subscribable<T2> v2, Number concurrent /* optional */);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d358<T2->),P(d2),P(d356))
      * TE Signature : S(merge,P(d358),P(d2),P(d356))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(Subscribable<T2> v2, Number concurrent /* optional */, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d358<T2->),P(d356))
      * TE Signature : S(merge,P(d358),P(d356))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(Subscribable<T2> v2, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d5<T2->))
      * TE Signature : S(merge,P(d5))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(ArrayLike<T2> v2);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d5<T2->),P(d2))
      * TE Signature : S(merge,P(d5),P(d2))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(ArrayLike<T2> v2, Number concurrent /* optional */);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d5<T2->),P(d2),P(d356))
      * TE Signature : S(merge,P(d5),P(d2),P(d356))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(ArrayLike<T2> v2, Number concurrent /* optional */, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(d5<T2->),P(d356))
      * TE Signature : S(merge,P(d5),P(d356))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(ArrayLike<T2> v2, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(dU(T2-5<T2->,16<5>,358<5>)))
      * TE Signature : S(merge,P(dU(-5,16,358)))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2);
    /** 
      * Std Signature : S(merge,357<U(T-,T2-T-,T2-)>,T2-,P(dU(T2-5<T2->,16<5>,358<5>)),P(d2))
      * TE Signature : S(merge,P(dU(-5,16,358)),P(d2))
      * 
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, Number concurrent /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 3
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, Number concurrent /* optional */, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    <T2> Observable<UnionOfTAndT2<T, T2>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, IScheduler scheduler /* optional */);
    /** 
      ...
      * 
     */
    <T2, T3> Observable<UnionOfTAndT2AndT3<T, T2, T3>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3);
    /** 
      ...
      * 
     */
    <T2, T3> Observable<UnionOfTAndT2AndT3<T, T2, T3>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, Number concurrent /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 5
     */
    <T2, T3> Observable<UnionOfTAndT2AndT3<T, T2, T3>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, Number concurrent /* optional */, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 4
     */
    <T2, T3> Observable<UnionOfTAndT2AndT3<T, T2, T3>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, IScheduler scheduler /* optional */);
    /** 
      ...
      * 
     */
    <T2, T3, T4> Observable<UnionOfTAndT2AndT3AndT4<T, T2, T3, T4>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4);
    /** 
      ...
      * 
     */
    <T2, T3, T4> Observable<UnionOfTAndT2AndT3AndT4<T, T2, T3, T4>> merge(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4, Number concurrent /* optional */);
    /** 
     ...
     */
    T mergeAll(Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <R> Observable<R> mergeMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R>> project);
    /** 
    ...
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/mergeMap.d.ts@301
     */
    <R> Observable<R> mergeMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R>> project, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> mergeMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I>> project, Function4<T, I, Number, Number, R> resultSelector);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <I, R> Observable<R> mergeMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I>> project, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(mergeMapTo,357<R->,R-,P(d16<R->))
      * TE Signature : S(mergeMapTo,P(d16))
      * 
     */
    <R> Observable<R> mergeMapTo(PromiseLike<R> observable);
    /** 
      * Std Signature : S(mergeMapTo,357<R->,R-,P(d16<R->),P(d2))
      * TE Signature : S(mergeMapTo,P(d16),P(d2))
      * 
     */
    <R> Observable<R> mergeMapTo(PromiseLike<R> observable, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> mergeMapTo(PromiseLike<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> mergeMapTo(PromiseLike<I> observable, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(mergeMapTo,357<R->,R-,P(d358<R->))
      * TE Signature : S(mergeMapTo,P(d358))
      * 
     */
    <R> Observable<R> mergeMapTo(Subscribable<R> observable);
    /** 
      * Std Signature : S(mergeMapTo,357<R->,R-,P(d358<R->),P(d2))
      * TE Signature : S(mergeMapTo,P(d358),P(d2))
      * 
     */
    <R> Observable<R> mergeMapTo(Subscribable<R> observable, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> mergeMapTo(Subscribable<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> mergeMapTo(Subscribable<I> observable, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(mergeMapTo,357<R->,R-,P(d5<R->))
      * TE Signature : S(mergeMapTo,P(d5))
      * 
     */
    <R> Observable<R> mergeMapTo(ArrayLike<R> observable);
    /** 
      * Std Signature : S(mergeMapTo,357<R->,R-,P(d5<R->),P(d2))
      * TE Signature : S(mergeMapTo,P(d5),P(d2))
      * 
     */
    <R> Observable<R> mergeMapTo(ArrayLike<R> observable, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> mergeMapTo(ArrayLike<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> mergeMapTo(ArrayLike<I> observable, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(mergeMapTo,357<R->,R-,P(dU(R-5<R->,16<5>,358<5>)))
      * TE Signature : S(mergeMapTo,P(dU(-5,16,358)))
      * 
     */
    <R> Observable<R> mergeMapTo(ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R> observable);
    /** 
    ...
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/mergeMapTo.d.ts@301
     */
    <R> Observable<R> mergeMapTo(ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R> observable, Number concurrent /* optional */);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> mergeMapTo(ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <I, R> Observable<R> mergeMapTo(ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I> observable, Function4<T, I, Number, Number, R> resultSelector, Number concurrent /* optional */);
    /** 
      * Std Signature : S(mergeScan,357<R->,R-,P(dFP1-,P2-,R--S(?,5,,P(d3),P(d4))------)<R-,T-,357<6>>),P(dR-))
      * TE Signature : S(mergeScan,P(dF--S(?,P(d3),P(d4))------)),P(d3))
      * 
     */
    <R> Observable<R> mergeScan(Function2<R, T, Observable<R>> accumulator, R seed);
    /** 
     ...
     */
    <R> Observable<R> mergeScan(Function2<R, T, Observable<R>> accumulator, R seed, Number concurrent /* optional */);
    /** 
     ...
     */
    Observable<T> min(Function2<T, T, Number> comparer /* optional */);
    /** 
      * Std Signature : S(multicast,825<T->,,P(d359<T->))
      * TE Signature : S(multicast,P(d359))
      * 
     */
    ConnectableObservable<T> multicast(Subject<T> subjectOrSubjectFactory);
    /** 
      * Std Signature : S(multicast,825<T->,,P(dFR--S(?,3,,)------)<359<T->>))
      * TE Signature : S(multicast,P(dF--S(?,)------)))
      * 
     */
    ConnectableObservable<T> multicast(Function<Subject<T>> subjectOrSubjectFactory);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Observable<T> multicast(Function<Subject<T>> SubjectFactory, Function1<Observable<T>, Observable<T>> selector /* optional */);
    /** 
     ...
     */
    ConnectableObservable<T> multicast(factoryOrValue_UnionOfFunctionOfSubjectOfTAndSubjectOfT<T> subjectOrSubjectFactory);
    /** 
     ...
     */
    Observable<T> observeOn(IScheduler scheduler, Number delay /* optional */);
    /** 
     ...
     */
    Tuple<Observable<T>, Observable<T>> partition(Function1<T, Boolean> predicate);
    /** 
      * Std Signature : S(pluck,357<R->,R-,)
      * TE Signature : S(pluck,)
      * 
     */
    <R> Observable<R> pluck();
    /** 
     ...
     */
    <R> Observable<R> pluck(String... properties);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Observable<T> publish(Function1<Observable<T>, Observable<T>> selector);
    /** 
    ...
    /** 
      ...
      * 
     */
    ConnectableObservable<T> publishReplay();
    /** 
      * Std Signature : S(publishReplay,825<T->,,P(d2))
      * TE Signature : S(publishReplay,P(d2))
      * 
     */
    ConnectableObservable<T> publishReplay(Number bufferSize /* optional */);
    /** 
      * Std Signature : S(publishReplay,825<T->,,P(d2),P(d2))
      * TE Signature : S(publishReplay,P(d2),P(d2))
      * 
     */
    ConnectableObservable<T> publishReplay(Number bufferSize /* optional */, Number windowTime /* optional */);
    /** 
     ...
     */
    ConnectableObservable<T> publishReplay(Number bufferSize /* optional */, Number windowTime /* optional */, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * 
     */
    Observable<T> race(Observable<T>... observables);
    /** 
      * Std Signature : S(race,357<T->,,P(D7<357<T->>))
      * TE Signature : S(race,P(D7))
      * 
     */
    Observable<T> race(Array<Observable<T>>... observables);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    Observable<T> race(UnionOfArrayOfObservableOfTAndObservableOfT<T>... observables);
    /** 
      * Std Signature : S(race,357<T->,,P(d7<357<T->>))
      * TE Signature : S(race,P(d7))
      * 
    ...
    /** 
      ...
      * VERSION 2
     */
    <R> Observable<R> reduce(Function3<R, T, Number, R> accumulator, R seed);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Observable<Array<T>> reduce(Function3<Array<T>, T, Number, Array<T>> accumulator, Array<T> seed);
    /** 
     ...
     */
    Observable<T> repeat(Number count /* optional */);
    /** 
     ...
     */
    Observable<T> repeatWhen(Function1<Observable<Object>, Observable<Object>> notifier);
    /** 
     ...
     */
    Observable<T> retry(Number count /* optional */);
    /** 
     ...
     */
    Observable<T> retryWhen(Function1<Observable<Object>, Observable<Object>> notifier);
    /** 
     ...
     */
    Observable<T> sample(Observable<Object> notifier);
    /** 
      * Std Signature : S(sampleTime,357<T->,,P(d2))
      * TE Signature : S(sampleTime,P(d2))
      * 
     */
    Observable<T> sampleTime(Number period);
    /** 
     ...
     */
    Observable<T> sampleTime(Number period, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(scan,357<R->,R-,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<R-,T-,2,7>))
      * TE Signature : S(scan,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    <R> Observable<R> scan(Function3<R, T, Number, R> accumulator);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    <R> Observable<R> scan(Function3<R, T, Number, R> accumulator, R seed /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Observable<Array<T>> scan(Function3<Array<T>, T, Number, Array<T>> accumulator, Array<T> seed /* optional */);
    /** 
      * Std Signature : S(sequenceEqual,357<27>,,P(d357<T->))
      * TE Signature : S(sequenceEqual,P(d357))
      * 
     */
    Observable<Boolean> sequenceEqual(Observable<T> compareTo);
    /** 
     ...
     */
    Observable<Boolean> sequenceEqual(Observable<T> compareTo, Function2<T, T, Boolean> comparor /* optional */);
    /** 
    ...
    /** 
      ...
      * 
     */
    Observable<T> shareReplay(Number bufferSize /* optional */);
    /** 
      * Std Signature : S(shareReplay,357<T->,,P(d2),P(d2))
      * TE Signature : S(shareReplay,P(d2),P(d2))
      * 
     */
    Observable<T> shareReplay(Number bufferSize /* optional */, Number windowTime /* optional */);
    /** 
     ...
     */
    Observable<T> shareReplay(Number bufferSize /* optional */, Number windowTime /* optional */, IScheduler scheduler /* optional */);
    /** 
     ...
     */
    Observable<T> single(Function3<T, Number, Observable<T>, Boolean> predicate /* optional */);
    /** 
     ...
     */
    Observable<T> skipUntil(Observable<Object> notifier);
    /** 
     ...
     */
    Observable<T> skipWhile(Function2<T, Number, Boolean> predicate);
    /** 
    ...
    /** 
      ...
      * 
     */
    Observable<T> startWith(T... array);
    /** 
      * Std Signature : S(startWith,357<T->,,P(D356))
      * TE Signature : S(startWith,P(D356))
      * 
     */
    Observable<T> startWith(IScheduler... array);
    /** 
    ...
    /** 
      ...
      * VERSION 5
     */
    Observable<T> startWith(T v1, T v2, T v3, T v4, T v5, T v6, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 4
     */
    Observable<T> startWith(T v1, T v2, T v3, T v4, T v5, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 3
     */
    Observable<T> startWith(T v1, T v2, T v3, T v4, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    Observable<T> startWith(T v1, T v2, T v3, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Observable<T> startWith(T v1, T v2, IScheduler scheduler /* optional */);
    /** 
     ...
     */
    Observable<T> startWith(T v1, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    Subscription subscribe(Action1<T> next /* optional */, Action1<Object> error /* optional */, Action complete /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Subscription subscribe(PartialObserver_UnionOfCompletionObserverOfTAndErrorObserverOfTAndNextObserverOfT<T> observer);
    /** 
     ...
     */
    Observable<T> subscribeOn(IScheduler scheduler, Number delay /* optional */);
    /** 
     ...
     */
    <R> Observable<R> switchMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R>> project);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <I, R> Observable<R> switchMap(Function2<T, Number, ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I>> project, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      * Std Signature : S(switchMapTo,357<R->,R-,P(d16<R->))
      * TE Signature : S(switchMapTo,P(d16))
      * 
     */
    <R> Observable<R> switchMapTo(PromiseLike<R> observable);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> switchMapTo(PromiseLike<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      * Std Signature : S(switchMapTo,357<R->,R-,P(d358<R->))
      * TE Signature : S(switchMapTo,P(d358))
      * 
     */
    <R> Observable<R> switchMapTo(Subscribable<R> observable);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> switchMapTo(Subscribable<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
      * Std Signature : S(switchMapTo,357<R->,R-,P(d5<R->))
      * TE Signature : S(switchMapTo,P(d5))
      * 
     */
    <R> Observable<R> switchMapTo(ArrayLike<R> observable);
    /** 
      ...
      * 
     */
    <I, R> Observable<R> switchMapTo(ArrayLike<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
     ...
     */
    <R> Observable<R> switchMapTo(ObservableInput_UnionOfArrayLikeOfRAndPromiseLikeOfRAndSubscribableOfR<R> observable);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <I, R> Observable<R> switchMapTo(ObservableInput_UnionOfArrayLikeOfIAndPromiseLikeOfIAndSubscribableOfI<I> observable, Function4<T, I, Number, Number, R> resultSelector);
    /** 
     ...
     */
    Observable<T> take(Number count);
    /** 
     ...
     */
    Observable<T> takeUntil(Observable<Object> notifier);
    /** 
     ...
     */
    Observable<T> takeWhile(Function2<T, Number, Boolean> predicate);
    /** 
      * Std Signature : S(throttle,357<T->,,P(dFP1-,R--S(?,4,,P(d3))------)<T-,U(-16<2>,358<9>)>))
      * TE Signature : S(throttle,P(dF--S(?,P(d3))------)))
      * 
     */
    Observable<T> throttle(Function1<T, SubscribableOrPromise_UnionOfPromiseLikeOfNumberAndSubscribableOfNumber> durationSelector);
    /** 
     ...
     */
    Observable<T> throttle(Function1<T, SubscribableOrPromise_UnionOfPromiseLikeOfNumberAndSubscribableOfNumber> durationSelector, ThrottleConfig config /* optional */);
    /** 
      * Std Signature : S(throttleTime,357<T->,,P(d2))
      * TE Signature : S(throttleTime,P(d2))
      * 
     */
    Observable<T> throttleTime(Number duration);
    /** 
      * Std Signature : S(throttleTime,357<T->,,P(d2),P(d356))
      * TE Signature : S(throttleTime,P(d2),P(d356))
      * 
     */
    Observable<T> throttleTime(Number duration, IScheduler scheduler /* optional */);
    /** 
     ...
     */
    Observable<T> throttleTime(Number duration, IScheduler scheduler /* optional */, ThrottleConfig config /* optional */);
    /** 
     ...
     */
    Observable<T> timeout(UnionOfDateAndNumber due, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(timeoutWith,357<T->,,P(dU(-13,2)),P(dU(T-5<T->,16<5>,358<5>)))
      * TE Signature : S(timeoutWith,P(dU(-13,2)),P(dU(-5,16,358)))
      * 
     */
    Observable<T> timeoutWith(UnionOfDateAndNumber due, ObservableInput_UnionOfArrayLikeOfTAndPromiseLikeOfTAndSubscribableOfT<T> withObservable);
    /** 
     ...
     */
    Observable<T> timeoutWith(UnionOfDateAndNumber due, ObservableInput_UnionOfArrayLikeOfTAndPromiseLikeOfTAndSubscribableOfT<T> withObservable, IScheduler scheduler /* optional */);
    /** 
      * Std Signature : S(timestamp,357<827<T->>,,)
      * TE Signature : S(timestamp,)
      * 
     */
    Observable<Timestamp<T>> timestamp();
    /** 
     ...
     */
    Observable<Timestamp<T>> timestamp(IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Promise<T> toPromise(Object PromiseCtor);
    /** 
     ...
     */
    Observable<Observable<T>> window(Observable<Object> windowBoundaries);
    /** 
      * Std Signature : S(windowCount,357<2<T->>,,P(d2))
      * TE Signature : S(windowCount,P(d2))
      * 
     */
    Observable<Observable<T>> windowCount(Number windowSize);
    /** 
     ...
     */
    Observable<Observable<T>> windowCount(Number windowSize, Number startWindowEvery /* optional */);
    /** 
      * Std Signature : S(windowTime,357<2<T->>,,P(d2))
      * TE Signature : S(windowTime,P(d2))
      * 
     */
    Observable<Observable<T>> windowTime(Number windowTimeSpan);
    /** 
      * Std Signature : S(windowTime,357<2<T->>,,P(d2),P(d2))
      * TE Signature : S(windowTime,P(d2),P(d2))
      * 
     */
    Observable<Observable<T>> windowTime(Number windowTimeSpan, Number windowCreationInterval);
    /** 
      * Std Signature : S(windowTime,357<2<T->>,,P(d2),P(d2),P(d2))
      * TE Signature : S(windowTime,P(d2),P(d2),P(d2))
      * 
     */
    Observable<Observable<T>> windowTime(Number windowTimeSpan, Number windowCreationInterval, Number maxWindowSize);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    Observable<Observable<T>> windowTime(Number windowTimeSpan, Number windowCreationInterval, Number maxWindowSize, IScheduler scheduler /* optional */);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    Observable<Observable<T>> windowTime(Number windowTimeSpan, Number windowCreationInterval, IScheduler scheduler /* optional */);
    /** 
     ...
     */
    Observable<Observable<T>> windowTime(Number windowTimeSpan, IScheduler scheduler /* optional */);
    /** 
     ...
     */
    <O> Observable<Observable<T>> windowToggle(Observable<O> openings, Function1<O, Observable<Object>> closingSelector);
    /** 
    ...
    /** 
      ...
      * VERSION 11
     */
    <R> Observable<R> withLatestFrom(UnionOfFunction1OfObjectAndRAndArrayLikeOfObjectAndPromiseLikeOfObjectAndSubscribableOfObject<R>... observables);
    /** 
      * Std Signature : S(withLatestFrom,357<25<T-,T2->>,T2-,P(d16<T2->))
      * TE Signature : S(withLatestFrom,P(d16))
      * 
     */
    <T2> Observable<Tuple<T, T2>> withLatestFrom(PromiseLike<T2> v2);
    /** 
      ...
      * 
     */
    <T2, R> Observable<R> withLatestFrom(PromiseLike<T2> v2, Function2<T, T2, R> project);
    /** 
      * Std Signature : S(withLatestFrom,357<25<T-,T2->>,T2-,P(d358<T2->))
      * TE Signature : S(withLatestFrom,P(d358))
      * 
     */
    <T2> Observable<Tuple<T, T2>> withLatestFrom(Subscribable<T2> v2);
    /** 
      ...
      * 
     */
    <T2, R> Observable<R> withLatestFrom(Subscribable<T2> v2, Function2<T, T2, R> project);
    /** 
      * Std Signature : S(withLatestFrom,357<25<T-,T2->>,T2-,P(d5<T2->))
      * TE Signature : S(withLatestFrom,P(d5))
      * 
     */
    <T2> Observable<Tuple<T, T2>> withLatestFrom(ArrayLike<T2> v2);
    /** 
      ...
      * 
     */
    <T2, R> Observable<R> withLatestFrom(ArrayLike<T2> v2, Function2<T, T2, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 12
     */
    <R> Observable<R> withLatestFrom(Array<ObservableInput_UnionOfArrayLikeOfObjectAndPromiseLikeOfObjectAndSubscribableOfObject> array);
    /** 
    ...
    /** 
      ...
      * VERSION 13
     */
    <R> Observable<R> withLatestFrom(Array<ObservableInput_UnionOfArrayLikeOfObjectAndPromiseLikeOfObjectAndSubscribableOfObject> array, Function1<Object, R> project);
    /** 
     ...
     */
    <R> Observable<R> withLatestFrom(Function1<T, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 6
     */
    <T2> Observable<Tuple<T, T2>> withLatestFrom(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <T2, R> Observable<R> withLatestFrom(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, Function2<T, T2, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 7
     */
    <T2, T3> Observable<TupleOf3<T, T2, T3>> withLatestFrom(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    <T2, T3, R> Observable<R> withLatestFrom(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, Function3<T, T2, T3, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 8
     */
    <T2, T3, T4> Observable<TupleOf4<T, T2, T3, T4>> withLatestFrom(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4);
    /** 
    ...
    /** 
      ...
      * VERSION 9
     */
    <T2, T3, T4, T5> Observable<TupleOf5<T, T2, T3, T4, T5>> withLatestFrom(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4, ObservableInput_UnionOfArrayLikeOfT5AndPromiseLikeOfT5AndSubscribableOfT5<T5> v5);
    /** 
    ...
    /** 
      ...
      * VERSION 10
     */
    <T2, T3, T4, T5, T6> Observable<TupleOf6<T, T2, T3, T4, T5, T6>> withLatestFrom(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4, ObservableInput_UnionOfArrayLikeOfT5AndPromiseLikeOfT5AndSubscribableOfT5<T5> v5, ObservableInput_UnionOfArrayLikeOfT6AndPromiseLikeOfT6AndSubscribableOfT6<T6> v6);
    /** 
    ...
    /** 
      ...
      * VERSION 12
     */
    <R> Observable<R> zip(Array<ObservableInput_UnionOfArrayLikeOfTAndPromiseLikeOfTAndSubscribableOfT<T>> array);
    /** 
    ...
    /** 
      ...
      * VERSION 13
     */
    <TOther, R> Observable<R> zip(Array<ObservableInput_UnionOfArrayLikeOfTOtherAndPromiseLikeOfTOtherAndSubscribableOfTOther<TOther>> array, Function2<T, TOther, R> project);
    /** 
      * Std Signature : S(zip,357<R->,R-,P(dFP1-,R--S(?,4,,P(d3))------)<T-,R->))
      * TE Signature : S(zip,P(dF--S(?,P(d3))------)))
      * 
     ...
     */
    <R> Observable<R> zip(Function1<T, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 6
     */
    <T2> Observable<Tuple<T, T2>> zip(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2);
    /** 
    ...
    /** 
      ...
      * VERSION 1
     */
    <T2, R> Observable<R> zip(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, Function2<T, T2, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 7
     */
    <T2, T3> Observable<TupleOf3<T, T2, T3>> zip(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3);
    /** 
    ...
    /** 
      ...
      * VERSION 2
     */
    <T2, T3, R> Observable<R> zip(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, Function3<T, T2, T3, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 8
     */
    <T2, T3, T4> Observable<TupleOf4<T, T2, T3, T4>> zip(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4);
    /** 
    ...
    /** 
      ...
      * VERSION 3
     */
    <T2, T3, T4, R> Observable<R> zip(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4, Function4<T, T2, T3, T4, R> project);
    /** 
    ...
    /** 
      ...
      * VERSION 9
     */
    <T2, T3, T4, T5> Observable<TupleOf5<T, T2, T3, T4, T5>> zip(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4, ObservableInput_UnionOfArrayLikeOfT5AndPromiseLikeOfT5AndSubscribableOfT5<T5> v5);
    /** 
    ...
    /** 
      ...
      * VERSION 10
     */
    <T2, T3, T4, T5, T6> Observable<TupleOf6<T, T2, T3, T4, T5, T6>> zip(ObservableInput_UnionOfArrayLikeOfT2AndPromiseLikeOfT2AndSubscribableOfT2<T2> v2, ObservableInput_UnionOfArrayLikeOfT3AndPromiseLikeOfT3AndSubscribableOfT3<T3> v3, ObservableInput_UnionOfArrayLikeOfT4AndPromiseLikeOfT4AndSubscribableOfT4<T4> v4, ObservableInput_UnionOfArrayLikeOfT5AndPromiseLikeOfT5AndSubscribableOfT5<T5> v5, ObservableInput_UnionOfArrayLikeOfT6AndPromiseLikeOfT6AndSubscribableOfT6<T6> v6);
    /** 
     ...
     */
    <R> Observable<R> zipAll(Function1<Object, R> project /* optional */);
}
