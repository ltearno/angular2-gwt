...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/groupBy".GroupedObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/operator/groupBy.d.ts:1185
  * 1 constructors
...
public class GroupedObservable<K, T> implements Observable<T>
{

    /*
        Constructors
    */
    public GroupedObservable(K key, Subject<T> groupSubject, RefCountSubscription refCountSubscription){
    }
    ...
    */
    ...
    public native Object getGroupSubject();

    @JsProperty( name = "groupSubject")
    public native void setGroupSubject( Object value );
    ...
    public native Object getRefCountSubscription();

    @JsProperty( name = "refCountSubscription")
    public native void setRefCountSubscription( Object value );
