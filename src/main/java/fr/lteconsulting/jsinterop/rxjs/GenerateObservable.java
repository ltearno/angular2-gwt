...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable".GenerateObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:1131
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="GenerateObservable")
public class GenerateObservable<T, S> implements Observable<T>
{

    /*
        Constructors
    */
    public GenerateObservable(S initialState, Function1<S, Boolean> condition, Function1<S, S> iterate, Function1<S, T> resultSelector, IScheduler scheduler){
    }
    ...
    */
    /** 
      ...
      * 
      * <img src="./img/generate.png" width="100%">): boolean} condition Condition to terminate generation (upon returning false).): S} iterate Iteration step function.): T} resultSelector Selector function for results produced in the sequence.
      * Generates an observable sequence by running a state-driven loop
      * producing the sequence's elements, using the specified scheduler
      * to send out observer messages.
      * The overload uses state as an emitted value.
      * 
      * <img src="./img/generate.png" width="100%">): boolean} condition Condition to terminate generation (upon returning false).): S} iterate Iteration step function.
      * Generates an observable sequence by running a state-driven loop
      * producing the sequence's elements, using the specified scheduler
      * to send out observer messages.
      ...
      * 
      * <img src="./img/generate.png" width="100%">
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:2809
     */
    @JsMethod(namespace="rxjs.GenerateObservable", name = "create")
    public static native <T, S> Observable<T> create(S initialState, Function1<S, Boolean> condition, Function1<S, S> iterate, Function1<S, T> resultSelector, IScheduler scheduler /* optional */);
    /** 
      * Generates an observable sequence by running a state-driven loop
      * producing the sequence's elements, using the specified scheduler
      * to send out observer messages.
      ...
      * <img src="./img/generate.png" width="100%">
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:2809
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:4141
     */
    @JsMethod(namespace="rxjs.GenerateObservable", name = "create")
    public static native <T, S> Observable<S> create(S initialState, Function1<S, Boolean> condition, Function1<S, S> iterate, IScheduler scheduler /* optional */);
    /** 
      * Generates an observable sequence by running a state-driven loop
      * producing the sequence's elements, using the specified scheduler
      * to send out observer messages.
      ...
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:2809
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:4141
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:5141
     */
    @JsMethod(namespace="rxjs.GenerateObservable", name = "create")
    public static native <T, S> Observable<S> create(GenerateBaseOptions<S> options);
    /** 
      * Generates an observable sequence by running a state-driven loop
      * producing the sequence's elements, using the specified scheduler
      * to send out observer messages.
      ...
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:4141
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:5141
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:6144
     */
    @JsMethod(namespace="rxjs.GenerateObservable", name = "create")
    public static native <T, S> Observable<T> create(GenerateOptions<T, S> options);
    /** 
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/GenerateObservable.d.ts:6303
     */
    @JsMethod(namespace="rxjs.GenerateObservable", name = "dispatch")
    public static native <T, S> Object dispatch(Object state);
    ...
    */
    ...
    public native Object getCondition();

    @JsProperty( name = "condition")
    public native void setCondition( Object value );

    public Object initialState;

    @JsProperty( name = "initialState")
    public native Object getInitialState();

    @JsProperty( name = "initialState")
    public native void setInitialState( Object value );

    public Object iterate;

    @JsProperty( name = "iterate")
    public native Object getIterate();

    @JsProperty( name = "iterate")
    public native void setIterate( Object value );
