...
import fr.lteconsulting.jsinterop.browser.WebSocket;
...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/WebSocketSubject".WebSocketSubject
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/WebSocketSubject.d.ts:713
  * 1 constructors
...
public class WebSocketSubject<T> extends AnonymousSubject<T>
{
    ...
    /*
        Constructors
    */
    public WebSocketSubject(UnionOfObservableOfTAndStringAndWebSocketSubjectConfig<T> urlConfigOrSource, Observer<T> destination){
        super(null, null);
    }
    ...
    */
    /** 
      ...
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/WebSocketSubject.d.ts:2560
     */
    @JsMethod(namespace="rxjs.WebSocketSubject", name = "create")
    public static native <T> WebSocketSubject<T> create(UnionOfStringAndWebSocketSubjectConfig urlConfigOrSource);
    ...
    */
    ...
    public native Object get_output();

    @JsProperty( name = "_output")
    public native void set_output( Object value );
    ...
    public native WebSocket getSocket();

    @JsProperty( name = "socket")
    public native void setSocket( WebSocket value );
    ...
    */
    ...
    /** 
      * Std Signature : S(_connectSocket,3,,)
      * TE Signature : S(_connectSocket,)
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/WebSocketSubject.d.ts@2964
     */
    public native Object _connectSocket();
    /** 
    ...
    /** 
      * Std Signature : S(_resetState,3,,)
      * TE Signature : S(_resetState,)
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/WebSocketSubject.d.ts@2827
     */
    public native Object _resetState();
    /** 
    ...
    /** 
      * Std Signature : S(multiplex,357<3>,,P(dFR--S(?,3,,)------)<3>),P(dFR--S(?,3,,)------)<3>),P(dFP1-,R--S(?,4,,P(d3))------)<T-,27>))
      * TE Signature : S(multiplex,P(dF--S(?,)------)),P(dF--S(?,)------)),P(dF--S(?,P(d3))------)))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/WebSocketSubject.d.ts@2854
     */
    public native Observable<Object> multiplex(Function<Object> subMsg, Function<Object> unsubMsg, Function1<T, Boolean> messageFilter);
    /** 
    ...
    /** 
      * Std Signature : S(resultSelector,3,,P(d84))
      * TE Signature : S(resultSelector,P(d84))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/dom/WebSocketSubject.d.ts@1250
     */
