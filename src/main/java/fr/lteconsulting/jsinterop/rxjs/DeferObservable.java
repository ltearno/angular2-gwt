...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/DeferObservable".DeferObservable
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/DeferObservable.d.ts:158
  * 1 constructors
  * We need this JSDoc comment for affecting ESDoc.
 */
@JsType(isNative=true, namespace="rxjs", name="DeferObservable")
public class DeferObservable<T> implements Observable<T>
{

    /*
        Constructors
    */
    public DeferObservable(Function<UnionOfPromiseLikeOfTAndSubscribableOfTAndVoid<T>> observableFactory){
    }
    ...
    */
    /** 
      ...
      * Observable.
      * source : c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/rxjs/observable/DeferObservable.d.ts:2485
     */
    @JsMethod(namespace="rxjs.DeferObservable", name = "create")
    public static native <T> Observable<T> create(Function<UnionOfPromiseLikeOfTAndSubscribableOfTAndVoid<T>> observableFactory);
