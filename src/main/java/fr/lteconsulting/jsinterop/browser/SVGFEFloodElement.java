...
/** 
  * base type: SVGFEFloodElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:588100
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:588479
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEFloodElement")
public class SVGFEFloodElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
