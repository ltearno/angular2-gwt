...
/** 
  * base type: HTMLMapElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:436400
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:436966
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLMapElement")
public class HTMLMapElement implements HTMLElement
{
