...
/** 
  * base type: SVGFEDisplacementMapElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:586442
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:587250
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEDisplacementMapElement")
public class SVGFEDisplacementMapElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
    ...
    */
    ...
    @JsProperty(namespace="SVGFEDisplacementMapElement", name="SVG_CHANNEL_A")
    public static Number SVG_CHANNEL_A;

    @JsProperty(namespace="SVGFEDisplacementMapElement", name="SVG_CHANNEL_B")
    public static Number SVG_CHANNEL_B;

    @JsProperty(namespace="SVGFEDisplacementMapElement", name="SVG_CHANNEL_G")
    public static Number SVG_CHANNEL_G;

    @JsProperty(namespace="SVGFEDisplacementMapElement", name="SVG_CHANNEL_R")
    public static Number SVG_CHANNEL_R;

    @JsProperty(namespace="SVGFEDisplacementMapElement", name="SVG_CHANNEL_UNKNOWN")
    public static Number SVG_CHANNEL_UNKNOWN;
    ...
    */
    ...
    @JsProperty( name = "scale")
    public native void setScale( SVGAnimatedNumber value );
    ...
    @JsProperty( name = "xChannelSelector")
    public native void setXChannelSelector( SVGAnimatedEnumeration value );
    ...
    @JsProperty( name = "yChannelSelector")
    public native void setYChannelSelector( SVGAnimatedEnumeration value );
