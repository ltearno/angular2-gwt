...
/** 
  * base type: Float64Array
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:175160
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:188219
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:230145
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:255132
  * base type: Float64Array
  * flags: 16384
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:175160
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:188219
...
public class Float64Array
{
    ...
    */
    ...
    public Float64Array(ArrayBuffer buffer, Number byteOffset, Number length){
    }
    ...
    */
    /** 
      ...
      * source : apis/browser-api/tsd/lib.es6.d.ts:187747
     */
    @JsMethod(namespace="Float64Array", name = "of")
    public static native Float64Array of(Number... items);
    /** 
      * Creates an array from an array-like or iterable object.
      * Creates an array from an array-like or iterable object.
      * source : apis/browser-api/tsd/lib.es6.d.ts:188097
     */
    ...
    /** 
      ...
      * Creates an array from an array-like or iterable object.
      * source : apis/browser-api/tsd/lib.es6.d.ts:188097
      * source : apis/browser-api/tsd/lib.es6.d.ts:231146
     */
    @JsMethod(namespace="Float64Array", name = "from")
    ...
    */
    ...
    /** 
      * Std Signature : S(copyWithin,36,,P(d2),P(d2))
      * TE Signature : S(copyWithin,P(d2),P(d2))
      * 
     */
    public native Float64Array copyWithin(Number target, Number start);
    /** 
      * Std Signature : S(copyWithin,36,,P(d2),P(d2),P(d2))
      * TE Signature : S(copyWithin,P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@176288
      * Returns the this object after copying a section of the array identified by start and end
      * to the same array starting at position target
     */
    public native Float64Array copyWithin(Number target, Number start, Number end /* optional */);
    /** 
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@230490
      * Returns an array of key, value pairs for every entry in the array
     */
    public native IterableIterator<Tuple<Number, Number>> entries();
    /** 
      * Std Signature : S(every,27,,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<2,7,36,27>))
      * TE Signature : S(every,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@176851
      * Determines whether all the members of an array satisfy the specified test.
     */
    public native Boolean every(Function3<Number, Number, Float64Array, Boolean> callbackfn);
    /** 
      * Std Signature : S(fill,36,,P(d2))
      * TE Signature : S(fill,P(d2))
      * 
     */
    public native Float64Array fill(Number value);
    /** 
      * Std Signature : S(fill,36,,P(d2),P(d2))
      * TE Signature : S(fill,P(d2),P(d2))
      * 
     */
    public native Float64Array fill(Number value, Number start /* optional */);
    /** 
      * Std Signature : S(fill,36,,P(d2),P(d2),P(d2))
      * TE Signature : S(fill,P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@177416
      * Returns the this object after filling the section identified by start and end with value
     */
    public native Float64Array fill(Number value, Number start /* optional */, Number end /* optional */);
    /** 
      * Std Signature : S(filter,36,,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<2,7,36,3>))
      * TE Signature : S(filter,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@177928
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@178615
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@179304
      * Returns the index of the first element in the array where predicate is true, and -1
      * otherwise.
     */
    public native Number findIndex(Function3<Number, Number, Array<Number>, Boolean> predicate);
    /** 
      * Std Signature : S(forEach,289,,P(dFP1-,P2-,P3--S(?,289,,P(d3),P(d4),P(d5))------)<2,7,36>))
      * TE Signature : S(forEach,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@179828
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@180225
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@180575
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@230604
    ...
    /** 
      * Std Signature : S(reduce,2,,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<2,8,8,36,8>),P(d2))
      * TE Signature : S(reduce,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@182300
      ...
      * call to the callback function.
     */
    public native Number reduce(Function4<Number, Number, Number, Float64Array, Number> callbackfn, Number initialValue /* optional */);
    /** 
      * Std Signature : S(reduce,U-,U-,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<U-,2,9,36,8>),P(dU-))
      * TE Signature : S(reduce,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@183117
      * Calls the specified callback function for all the elements in an array. The return value of
      * the callback function is the accumulated result, and is provided as an argument in the next
      * call to the callback function.
      * Calls the specified callback function for all the elements in an array. The return value of
      ...
      * VERSION 1
     */
    public native <U> U reduce(Function4<U, Number, Number, Float64Array, U> callbackfn, U initialValue);
    /** 
      * Std Signature : S(reduceRight,2,,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<2,8,8,36,8>))
    ...
    /** 
      * Std Signature : S(reduceRight,2,,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<2,8,8,36,8>),P(d2))
      * TE Signature : S(reduceRight,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@183942
      ...
      * argument in the next call to the callback function.
     */
    public native Number reduceRight(Function4<Number, Number, Number, Float64Array, Number> callbackfn, Number initialValue /* optional */);
    /** 
      * Std Signature : S(reduceRight,U-,U-,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<U-,2,9,36,8>),P(dU-))
      * TE Signature : S(reduceRight,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@184790
      * Calls the specified callback function for all the elements in an array, in descending order.
      * The return value of the callback function is the accumulated result, and is provided as an
      * argument in the next call to the callback function.
      * Calls the specified callback function for all the elements in an array, in descending order.
      ...
      * VERSION 1
     */
    public native <U> U reduceRight(Function4<U, Number, Number, Float64Array, U> callbackfn, U initialValue);
    /** 
      * Std Signature : S(reverse,36,,)
      * TE Signature : S(reverse,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@184993
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@185178
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@185441
      * Sets a value or an array of values.
      * Sets a value or an array of values.
      * VERSION 1
     */
    ...
    /** 
      * Std Signature : S(slice,36,,)
      * TE Signature : S(slice,)
      * 
     */
    public native Float64Array slice();
    /** 
      * Std Signature : S(slice,36,,P(d2))
      * TE Signature : S(slice,P(d2))
      * 
     */
    public native Float64Array slice(Number start /* optional */);
    /** 
      * Std Signature : S(slice,36,,P(d2),P(d2))
      * TE Signature : S(slice,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@185696
      * Returns a section of an array.
     */
    public native Float64Array slice(Number start /* optional */, Number end /* optional */);
    /** 
      * Std Signature : S(some,27,,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<2,7,36,27>))
      * TE Signature : S(some,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@186263
      * Determines whether the specified callback function returns true for any element of an array.
     */
    public native Boolean some(Function3<Number, Number, Float64Array, Boolean> callbackfn);
    /** 
      * Std Signature : S(sort,36,,)
      * TE Signature : S(sort,)
      * 
     */
    public native Float64Array sort();
    /** 
      * Std Signature : S(sort,36,,P(dFP1-,P2-,R--S(?,5,,P(d3),P(d4))------)<2,6,6>))
      * TE Signature : S(sort,P(dF--S(?,P(d3),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@186591
      * Sorts an array.
     */
    public native Float64Array sort(Function2<Number, Number, Number> compareFn /* optional */);
    /** 
      * Std Signature : S(subarray,36,,P(d2))
      * TE Signature : S(subarray,P(d2))
      * 
     */
    public native Float64Array subarray(Number begin);
    /** 
      * Std Signature : S(subarray,36,,P(d2),P(d2))
      * TE Signature : S(subarray,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@186941
      * Gets a new Float64Array view of the ArrayBuffer store for this array, referencing the elements
      * at begin, inclusive, up to end, exclusive.
     */
    public native Float64Array subarray(Number begin, Number end /* optional */);
    /** 
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@187083
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@230707
