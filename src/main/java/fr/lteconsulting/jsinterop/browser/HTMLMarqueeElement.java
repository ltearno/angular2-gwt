...
/** 
  * base type: HTMLMarqueeElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:437176
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:437987
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLMarqueeElement")
public class HTMLMarqueeElement implements HTMLElement
{
    ...
    */
    ...
    @JsProperty( name = "loop")
    public native void setLoop( Number value );
    ...
    @JsProperty( name = "scrollAmount")
    public native void setScrollAmount( Number value );
    ...
    @JsProperty( name = "scrollDelay")
    public native void setScrollDelay( Number value );
    ...
    */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@437647
     */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@437666
     */
