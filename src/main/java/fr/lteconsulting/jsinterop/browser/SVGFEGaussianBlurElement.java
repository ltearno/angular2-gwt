...
/** 
  * base type: SVGFEGaussianBlurElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:590378
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:590975
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEGaussianBlurElement")
public class SVGFEGaussianBlurElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
    ...
    */
    ...
    @JsProperty( name = "stdDeviationX")
    public native void setStdDeviationX( SVGAnimatedNumber value );
    ...
    @JsProperty( name = "stdDeviationY")
    public native void setStdDeviationY( SVGAnimatedNumber value );
    ...
    */
    ...
    /** 
      * Std Signature : S(setStdDeviation,289,,P(d2),P(d2))
      * TE Signature : S(setStdDeviation,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@590609
     */
    public native void setStdDeviation(Number stdDeviationX, Number stdDeviationY);
    /** 
