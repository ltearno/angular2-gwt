...
/** 
  * base type: HTMLSlotElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:743975
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLSlotElement")
public class HTMLSlotElement implements HTMLElement
{
    ...
    */
    ...
    /** 
      * Std Signature : S(assignedNodes,7<86>,,)
      * TE Signature : S(assignedNodes,)
      * 
     */
    public native Array<Node> assignedNodes();
    /** 
      * Std Signature : S(assignedNodes,7<86>,,P(d128))
      * TE Signature : S(assignedNodes,P(d128))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@744047
     */
