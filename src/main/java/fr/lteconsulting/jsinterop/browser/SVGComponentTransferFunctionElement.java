...
/** 
  * base type: SVGComponentTransferFunctionElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:573718
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:574745
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGComponentTransferFunctionElement")
public class SVGComponentTransferFunctionElement implements SVGElement
{
