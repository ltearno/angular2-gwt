...
/** 
  * base type: HTMLOptGroupElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:452780
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:454018
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLOptGroupElement")
public class HTMLOptGroupElement implements HTMLElement
{
