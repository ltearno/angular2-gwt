...
/** 
  * base type: SVGFEColorMatrixElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:581092
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:581883
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEColorMatrixElement")
public class SVGFEColorMatrixElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
    ...
    */
    ...
    @JsProperty(namespace="SVGFEColorMatrixElement", name="SVG_FECOLORMATRIX_TYPE_HUEROTATE")
    public static Number SVG_FECOLORMATRIX_TYPE_HUEROTATE;

    @JsProperty(namespace="SVGFEColorMatrixElement", name="SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA")
    public static Number SVG_FECOLORMATRIX_TYPE_LUMINANCETOALPHA;

    @JsProperty(namespace="SVGFEColorMatrixElement", name="SVG_FECOLORMATRIX_TYPE_MATRIX")
    public static Number SVG_FECOLORMATRIX_TYPE_MATRIX;

    @JsProperty(namespace="SVGFEColorMatrixElement", name="SVG_FECOLORMATRIX_TYPE_SATURATE")
    public static Number SVG_FECOLORMATRIX_TYPE_SATURATE;

    @JsProperty(namespace="SVGFEColorMatrixElement", name="SVG_FECOLORMATRIX_TYPE_UNKNOWN")
    public static Number SVG_FECOLORMATRIX_TYPE_UNKNOWN;
    ...
    */
    ...
    @JsProperty( name = "values")
    public native void setValues( SVGAnimatedNumberList value );
