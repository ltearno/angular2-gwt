...
/** 
  * base type: TextTrackList
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:657326
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:657834
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="TextTrackList")
public class TextTrackList implements EventTarget
{
    ...
    */
    ...
    /** 
      * Std Signature : S(item,336,,P(d2))
      * TE Signature : S(item,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@657478
     */
    public native TextTrack item(Number index);
    /** 
