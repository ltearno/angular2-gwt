...
/** 
  * base type: HTMLTableColElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:470805
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:471478
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLTableColElement")
public class HTMLTableColElement extends HTMLTableAlignment implements HTMLElement
{
    ...
    */
    ...
    @JsProperty( name = "span")
    public native void setSpan( Number value );
