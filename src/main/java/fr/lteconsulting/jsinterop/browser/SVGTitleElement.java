...
/** 
  * base type: SVGTitleElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:633761
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:634098
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGTitleElement")
public class SVGTitleElement implements SVGElement
{
