...
/** 
  * base type: SVGGradientElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:600013
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:600731
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGGradientElement")
public class SVGGradientElement extends SVGUnitTypes implements SVGElement, SVGURIReference
{
