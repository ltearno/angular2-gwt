...
/** 
  * base type: Worker
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:716123
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:716585
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="Worker")
public class Worker extends AbstractWorker implements EventTarget
{
    ...
    */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@716240
     */
    ...
    /** 
      * Std Signature : S(terminate,289,,)
      * TE Signature : S(terminate,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@716295
     */
