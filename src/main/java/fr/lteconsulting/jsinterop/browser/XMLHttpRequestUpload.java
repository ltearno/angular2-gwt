...
/** 
  * base type: XMLHttpRequestUpload
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:718793
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:719198
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="XMLHttpRequestUpload")
public class XMLHttpRequestUpload extends XMLHttpRequestEventTarget implements EventTarget
{
