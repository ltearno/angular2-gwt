...
/** 
  * base type: HTMLMetaElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:445704
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:446842
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLMetaElement")
public class HTMLMetaElement implements HTMLElement
{
