...
/** 
  * base type: HTMLQuoteElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:460115
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:460558
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLQuoteElement")
public class HTMLQuoteElement implements HTMLElement
{
