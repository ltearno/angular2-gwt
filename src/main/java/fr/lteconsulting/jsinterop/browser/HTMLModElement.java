...
/** 
  * base type: HTMLModElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:447458
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:448013
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLModElement")
public class HTMLModElement implements HTMLElement
{
