...
/** 
  * base type: SVGFEMergeElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:591632
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:592011
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEMergeElement")
public class SVGFEMergeElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
