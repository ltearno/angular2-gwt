...
/** 
  * base type: HTMLTrackElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:484935
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:485552
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLTrackElement")
public class HTMLTrackElement implements HTMLElement
{
