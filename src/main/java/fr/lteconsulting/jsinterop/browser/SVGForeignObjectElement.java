...
/** 
  * base type: SVGForeignObjectElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:598992
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:599502
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGForeignObjectElement")
public class SVGForeignObjectElement implements SVGGraphicsElement
{
