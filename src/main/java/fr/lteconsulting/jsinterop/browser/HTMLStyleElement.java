...
/** 
  * base type: HTMLStyleElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:467731
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:468292
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLStyleElement")
public class HTMLStyleElement extends LinkStyle implements HTMLElement
{
