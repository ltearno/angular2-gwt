...
/** 
  * base type: HTMLAreaElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:382811
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:384667
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLAreaElement")
public class HTMLAreaElement implements HTMLElement
{
