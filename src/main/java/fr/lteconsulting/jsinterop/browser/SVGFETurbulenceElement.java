...
/** 
  * base type: SVGFETurbulenceElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:596783
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:597737
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFETurbulenceElement")
public class SVGFETurbulenceElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
