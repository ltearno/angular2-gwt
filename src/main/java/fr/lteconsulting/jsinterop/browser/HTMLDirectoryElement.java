...
/** 
  * base type: HTMLDirectoryElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:396730
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:397102
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLDirectoryElement")
public class HTMLDirectoryElement implements HTMLElement
{
