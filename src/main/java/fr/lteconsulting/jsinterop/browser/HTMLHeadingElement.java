...
/** 
  * base type: HTMLHeadingElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:418828
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:419280
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLHeadingElement")
public class HTMLHeadingElement implements HTMLElement
{
