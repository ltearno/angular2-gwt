...
/** 
  * base type: SVGUseElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:636082
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:636691
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGUseElement")
public class SVGUseElement implements SVGGraphicsElement, SVGURIReference
{
