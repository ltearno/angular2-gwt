...
/** 
  * base type: HTMLLinkElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:435056
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:436319
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLLinkElement")
public class HTMLLinkElement extends LinkStyle implements HTMLElement
{
