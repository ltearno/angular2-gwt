...
/** 
  * base type: SVGTextContentElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:630188
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:631226
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGTextContentElement")
public class SVGTextContentElement implements SVGGraphicsElement
{
    ...
    */
    ...
    /** 
      * Std Signature : S(getCharNumAtPosition,2,,P(d120))
      * TE Signature : S(getCharNumAtPosition,P(d120))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@630350
     */
    ...
    /** 
      * Std Signature : S(getComputedTextLength,2,,)
      * TE Signature : S(getComputedTextLength,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@630401
     */
    ...
    /** 
      * Std Signature : S(getEndPositionOfChar,120,,P(d2))
      * TE Signature : S(getEndPositionOfChar,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@630438
     */
    public native SVGPoint getEndPositionOfChar(Number charnum);
    /** 
      * Std Signature : S(getExtentOfChar,118,,P(d2))
      * TE Signature : S(getExtentOfChar,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@630491
     */
    public native SVGRect getExtentOfChar(Number charnum);
    /** 
      * Std Signature : S(getNumberOfChars,2,,)
      * TE Signature : S(getNumberOfChars,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@630538
     */
    public native Number getNumberOfChars();
    /** 
      * Std Signature : S(getRotationOfChar,2,,P(d2))
      * TE Signature : S(getRotationOfChar,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@630570
     */
    public native Number getRotationOfChar(Number charnum);
    /** 
    ...
    /** 
      * Std Signature : S(getStartPositionOfChar,120,,P(d2))
      * TE Signature : S(getStartPositionOfChar,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@630618
     */
    public native SVGPoint getStartPositionOfChar(Number charnum);
    /** 
      * Std Signature : S(getSubStringLength,2,,P(d2),P(d2))
      * TE Signature : S(getSubStringLength,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@630673
     */
    public native Number getSubStringLength(Number charnum, Number nchars);
    /** 
    ...
    /** 
      * Std Signature : S(selectSubString,289,,P(d2),P(d2))
      * TE Signature : S(selectSubString,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@630738
     */
    public native void selectSubString(Number charnum, Number nchars);
    /** 
