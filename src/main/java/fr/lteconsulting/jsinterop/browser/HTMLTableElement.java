...
/** 
  * base type: HTMLTableElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:472046
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:475637
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLTableElement")
public class HTMLTableElement implements HTMLElement
{
    ...
    */
    ...
    @JsProperty( name = "cols")
    public native void setCols( Number value );
    ...
    */
    ...
    /** 
      * Std Signature : S(createCaption,554,,)
      * TE Signature : S(createCaption,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@474025
      * Creates an empty caption element in the table.
     */
    public native HTMLTableCaptionElement createCaption();
    /** 
      * Std Signature : S(createTBody,555,,)
      * TE Signature : S(createTBody,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@474141
      * Creates an empty tBody element in the table.
     */
    public native HTMLTableSectionElement createTBody();
    /** 
      * Std Signature : S(createTFoot,555,,)
      * TE Signature : S(createTFoot,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@474255
      * Creates an empty tFoot element in the table.
     */
    public native HTMLTableSectionElement createTFoot();
    /** 
      * Std Signature : S(createTHead,555,,)
      * TE Signature : S(createTHead,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@474391
      * Returns the tHead element object if successful, or null otherwise.
     */
    public native HTMLTableSectionElement createTHead();
    /** 
      * Std Signature : S(deleteCaption,289,,)
      * TE Signature : S(deleteCaption,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@474521
      * Deletes the caption element and its contents from the table.
     */
    public native void deleteCaption();
    /** 
      * Std Signature : S(deleteRow,289,,)
      * TE Signature : S(deleteRow,)
      * 
     */
    public native void deleteRow();
    /** 
      * Std Signature : S(deleteRow,289,,P(d2))
      * TE Signature : S(deleteRow,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@474763
      * Removes the specified row (tr) from the element and from the rows collection.
     */
    public native void deleteRow(Number index /* optional */);
    /** 
      * Std Signature : S(deleteTFoot,289,,)
      * TE Signature : S(deleteTFoot,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@474884
      * Deletes the tFoot element and its contents from the table.
     */
    public native void deleteTFoot();
    /** 
      * Std Signature : S(deleteTHead,289,,)
      * TE Signature : S(deleteTHead,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@474993
    ...
    /** 
      * Std Signature : S(insertRow,556,,)
      * TE Signature : S(insertRow,)
      * 
     */
    public native HTMLTableRowElement insertRow();
    /** 
      * Std Signature : S(insertRow,556,,P(d2))
      * TE Signature : S(insertRow,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@475298
      * Creates a new row (tr) in the table, and adds the row to the rows collection.
     */
    public native HTMLTableRowElement insertRow(Number index /* optional */);
    /** 
