...
/** 
  * base type: HTMLBRElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:385357
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:385873
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLBRElement")
public class HTMLBRElement implements HTMLElement
{
