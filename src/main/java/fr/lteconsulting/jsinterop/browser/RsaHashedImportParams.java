...
/** 
  * base type: RsaHashedImportParams
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:740440
  * 
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="RsaHashedImportParams")
