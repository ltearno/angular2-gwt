...
/** 
  * base type: SVGFESpotLightElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:595502
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:596186
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFESpotLightElement")
public class SVGFESpotLightElement implements SVGElement
{
