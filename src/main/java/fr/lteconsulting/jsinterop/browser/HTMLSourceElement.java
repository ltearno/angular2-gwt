...
/** 
  * base type: HTMLSourceElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:466514
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:467223
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLSourceElement")
public class HTMLSourceElement implements HTMLElement
{
