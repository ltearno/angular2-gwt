...
/** 
  * base type: SVGSVGElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:624322
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:626953
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGSVGElement")
public class SVGSVGElement implements SVGGraphicsElement, DocumentEvent, SVGFitToViewBox, SVGZoomAndPan
{
    ...
    */
    ...
    @JsProperty( name = "currentScale")
    public native void setCurrentScale( Number value );
    ...
    @JsProperty( name = "pixelUnitToMillimeterX")
    public native void setPixelUnitToMillimeterX( Number value );
    ...
    @JsProperty( name = "pixelUnitToMillimeterY")
    public native void setPixelUnitToMillimeterY( Number value );
    ...
    @JsProperty( name = "screenPixelToMillimeterX")
    public native void setScreenPixelToMillimeterX( Number value );
    ...
    @JsProperty( name = "screenPixelToMillimeterY")
    public native void setScreenPixelToMillimeterY( Number value );
    ...
    */
    ...
    /** 
      * Std Signature : S(checkEnclosure,27,,P(d116),P(d118))
      * TE Signature : S(checkEnclosure,P(d116),P(d118))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625258
     */
    public native Boolean checkEnclosure(SVGElement element, SVGRect rect);
    /** 
      * Std Signature : S(checkIntersection,27,,P(d116),P(d118))
      * TE Signature : S(checkIntersection,P(d116),P(d118))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625323
     */
    ...
    /** 
      * Std Signature : S(createSVGAngle,129,,)
      * TE Signature : S(createSVGAngle,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625391
     */
    public native SVGAngle createSVGAngle();
    /** 
      * Std Signature : S(createSVGLength,121,,)
      * TE Signature : S(createSVGLength,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625423
     */
    public native SVGLength createSVGLength();
    /** 
      * Std Signature : S(createSVGMatrix,94,,)
      * TE Signature : S(createSVGMatrix,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625457
     */
    public native SVGMatrix createSVGMatrix();
    /** 
      * Std Signature : S(createSVGNumber,122,,)
      * TE Signature : S(createSVGNumber,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625491
     */
    public native SVGNumber createSVGNumber();
    /** 
      * Std Signature : S(createSVGPoint,120,,)
      * TE Signature : S(createSVGPoint,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625525
     */
    public native SVGPoint createSVGPoint();
    /** 
      * Std Signature : S(createSVGRect,118,,)
      * TE Signature : S(createSVGRect,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625557
     */
    public native SVGRect createSVGRect();
    /** 
      * Std Signature : S(createSVGTransform,115,,)
      * TE Signature : S(createSVGTransform,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625587
     */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625627
     */
    public native SVGTransform createSVGTransformFromMatrix(SVGMatrix matrix);
    /** 
      * Std Signature : S(deselectAll,289,,)
      * TE Signature : S(deselectAll,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625694
     */
    ...
    /** 
      * Std Signature : S(forceRedraw,289,,)
      * TE Signature : S(forceRedraw,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625719
     */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625744
     */
    public native CSSStyleDeclaration getComputedStyle(Element elt, String pseudoElt /* optional */);
    /** 
      * Std Signature : S(getCurrentTime,2,,)
      * TE Signature : S(getCurrentTime,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625821
     */
    public native Number getCurrentTime();
    /** 
      * Std Signature : S(getElementById,49,,P(d1))
      * TE Signature : S(getElementById,P(d1))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625851
     */
    ...
    /** 
      * Std Signature : S(getEnclosureList,377<U(-341,342,343,344,345,346,347,348,349,350)>,,P(d118),P(d116))
      * TE Signature : S(getEnclosureList,P(d118),P(d116))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@625899
     */
    public native NodeListOf<UnionOfSeveralSVGElements> getEnclosureList(SVGRect rect, SVGElement referenceElement);
    /** 
      * Std Signature : S(getIntersectionList,377<U(-341,342,343,344,345,346,347,348,349,350)>,,P(d118),P(d116))
      * TE Signature : S(getIntersectionList,P(d118),P(d116))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@626159
     */
    public native NodeListOf<UnionOfSeveralSVGElements> getIntersectionList(SVGRect rect, SVGElement referenceElement);
    /** 
    ...
    /** 
      * Std Signature : S(pauseAnimations,289,,)
      * TE Signature : S(pauseAnimations,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@626422
     */
    ...
    /** 
      * Std Signature : S(setCurrentTime,289,,P(d2))
      * TE Signature : S(setCurrentTime,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@626451
     */
    public native void setCurrentTime(Number seconds);
    /** 
    ...
    /** 
      * Std Signature : S(suspendRedraw,2,,P(d2))
      * TE Signature : S(suspendRedraw,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@626494
     */
    public native Number suspendRedraw(Number maxWaitMilliseconds);
    /** 
      * Std Signature : S(unpauseAnimations,289,,)
      * TE Signature : S(unpauseAnimations,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@626550
     */
    public native void unpauseAnimations();
    /** 
      * Std Signature : S(unsuspendRedraw,289,,P(d2))
      * TE Signature : S(unsuspendRedraw,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@626581
     */
    public native void unsuspendRedraw(Number suspendHandleID);
    /** 
      * Std Signature : S(unsuspendRedrawAll,289,,)
      * TE Signature : S(unsuspendRedrawAll,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@626633
     */
