...
/** 
  * base type: SVGCircleElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:572673
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:573127
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGCircleElement")
public class SVGCircleElement implements SVGGraphicsElement
{
