...
/** 
  * base type: HTMLParagraphElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:456612
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:457090
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLParagraphElement")
public class HTMLParagraphElement implements HTMLElement
{
