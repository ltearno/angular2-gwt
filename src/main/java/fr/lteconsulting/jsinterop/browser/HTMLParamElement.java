...
/** 
  * base type: HTMLParamElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:457186
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:457979
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLParamElement")
public class HTMLParamElement implements HTMLElement
{
