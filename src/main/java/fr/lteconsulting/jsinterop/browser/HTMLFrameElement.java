...
/** 
  * base type: HTMLFrameElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:412373
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:414500
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLFrameElement")
public class HTMLFrameElement implements HTMLElement, GetSVGDocument
{
    ...
    */
     ...
     */
    public PropertyKey_UnionOfNumberAndString height;

    @JsProperty( name = "height")
    public native PropertyKey_UnionOfNumberAndString getHeight();

    @JsProperty( name = "height")
    public native void setHeight( PropertyKey_UnionOfNumberAndString value );

    @JsOverlay
    public final void setHeight( Number value ) { setHeight(PropertyKey_UnionOfNumberAndString.ofNumber( value )); }

    @JsOverlay
    public final void setHeight( String value ) { setHeight(PropertyKey_UnionOfNumberAndString.ofString( value )); }
     ...
     */
    public PropertyKey_UnionOfNumberAndString width;

    @JsProperty( name = "width")
    public native PropertyKey_UnionOfNumberAndString getWidth();

    @JsProperty( name = "width")
    public native void setWidth( PropertyKey_UnionOfNumberAndString value );

    @JsOverlay
    public final void setWidth( Number value ) { setWidth(PropertyKey_UnionOfNumberAndString.ofNumber( value )); }

    @JsOverlay
    public final void setWidth( String value ) { setWidth(PropertyKey_UnionOfNumberAndString.ofString( value )); }
