...
/** 
  * base type: HTMLTableCaptionElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:468376
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:468960
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLTableCaptionElement")
public class HTMLTableCaptionElement implements HTMLElement
{
