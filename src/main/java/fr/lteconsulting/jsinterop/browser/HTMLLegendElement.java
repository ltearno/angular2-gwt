...
/** 
  * base type: HTMLLegendElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:434388
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:434969
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLLegendElement")
public class HTMLLegendElement implements HTMLElement
{
