...
/** 
  * base type: HTMLOListElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:448091
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:448538
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLOListElement")
public class HTMLOListElement implements HTMLElement
{
