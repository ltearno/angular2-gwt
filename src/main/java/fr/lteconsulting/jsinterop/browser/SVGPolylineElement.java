...
/** 
  * base type: SVGPolylineElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:620536
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:620906
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGPolylineElement")
public class SVGPolylineElement extends SVGAnimatedPoints implements SVGGraphicsElement
{
