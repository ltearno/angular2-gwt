...
/** 
  * base type: RTCStatsProvider
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:565843
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:565992
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="RTCStatsProvider")
public class RTCStatsProvider implements EventTarget
{
    ...
    */
    ...
    /** 
      * Std Signature : S(getStats,88<276>,,)
      * TE Signature : S(getStats,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@565898
     */
    public native Promise<RTCStatsReport> getStats();
    /** 
      * Std Signature : S(msGetStats,88<276>,,)
      * TE Signature : S(msGetStats,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@565939
     */
