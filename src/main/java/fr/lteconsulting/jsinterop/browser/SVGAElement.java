...
/** 
  * base type: SVGAElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:568946
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:569340
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGAElement")
public class SVGAElement implements SVGGraphicsElement, SVGURIReference
{
