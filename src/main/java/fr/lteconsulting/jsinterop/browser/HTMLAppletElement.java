...
/** 
  * base type: HTMLAppletElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:380392
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:382724
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLAppletElement")
public class HTMLAppletElement implements HTMLElement
{
