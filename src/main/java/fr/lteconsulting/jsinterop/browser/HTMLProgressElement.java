...
/** 
  * base type: HTMLProgressElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:459055
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:460022
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLProgressElement")
public class HTMLProgressElement implements HTMLElement
{
