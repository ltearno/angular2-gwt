...
/** 
  * base type: HTMLDListElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:395351
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:395715
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLDListElement")
public class HTMLDListElement implements HTMLElement
{
