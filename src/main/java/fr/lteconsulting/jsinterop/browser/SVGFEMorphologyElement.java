...
/** 
  * base type: SVGFEMorphologyElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:592583
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:593297
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEMorphologyElement")
public class SVGFEMorphologyElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
    ...
    */
    ...
    @JsProperty(namespace="SVGFEMorphologyElement", name="SVG_MORPHOLOGY_OPERATOR_DILATE")
    public static Number SVG_MORPHOLOGY_OPERATOR_DILATE;

    @JsProperty(namespace="SVGFEMorphologyElement", name="SVG_MORPHOLOGY_OPERATOR_ERODE")
    public static Number SVG_MORPHOLOGY_OPERATOR_ERODE;

    @JsProperty(namespace="SVGFEMorphologyElement", name="SVG_MORPHOLOGY_OPERATOR_UNKNOWN")
    public static Number SVG_MORPHOLOGY_OPERATOR_UNKNOWN;
    ...
    */
    ...
    @JsProperty( name = "radiusX")
    public native void setRadiusX( SVGAnimatedNumber value );
    ...
    @JsProperty( name = "radiusY")
    public native void setRadiusY( SVGAnimatedNumber value );
