...
/** 
  * base type: SVGMetadataElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:608056
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:608399
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGMetadataElement")
public class SVGMetadataElement implements SVGElement
{
