...
/** 
  * base type: SVGFETileElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:596285
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:596699
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFETileElement")
public class SVGFETileElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
