...
/** 
  * base type: SVGFEConvolveMatrixElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:584316
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:585410
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEConvolveMatrixElement")
public class SVGFEConvolveMatrixElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
