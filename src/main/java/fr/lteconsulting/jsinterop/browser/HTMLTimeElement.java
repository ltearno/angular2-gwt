...
/** 
  * base type: HTMLTimeElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:483968
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:484330
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLTimeElement")
public class HTMLTimeElement implements HTMLElement
{
