...
/** 
  * base type: HTMLLIElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:433198
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:433640
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLLIElement")
public class HTMLLIElement implements HTMLElement
{
