...
/** 
  * base type: SVGFEPointLightElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:594138
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:594594
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEPointLightElement")
public class SVGFEPointLightElement implements SVGElement
{
