...
/** 
  * base type: HTMLBodyElementEventMap
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:387239
  * 
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLBodyElementEventMap")
public class HTMLBodyElementEventMap extends HTMLElementEventMap
{
