...
/** 
  * base type: ConstrainDOMStringParameters
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:256632
  * 
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="ConstrainDOMStringParameters")
