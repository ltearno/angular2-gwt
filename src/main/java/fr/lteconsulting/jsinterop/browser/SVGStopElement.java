...
/** 
  * base type: SVGStopElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:627486
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:627861
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGStopElement")
public class SVGStopElement implements SVGElement
{
