...
/** 
  * base type: HTMLPictureElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:458063
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:458409
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLPictureElement")
public class HTMLPictureElement implements HTMLElement
{
