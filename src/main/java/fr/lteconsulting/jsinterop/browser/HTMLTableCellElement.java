...
/** 
  * base type: HTMLTableCellElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:469065
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:470709
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLTableCellElement")
public class HTMLTableCellElement extends HTMLTableAlignment implements HTMLElement
{
    ...
    */
    ...
    @JsProperty( name = "cellIndex")
    public native void setCellIndex( Number value );
    ...
    @JsProperty( name = "colSpan")
    public native void setColSpan( Number value );
    ...
    @JsProperty( name = "rowSpan")
    public native void setRowSpan( Number value );
