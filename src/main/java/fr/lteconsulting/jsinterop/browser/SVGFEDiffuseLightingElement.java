...
/** 
  * base type: SVGFEDiffuseLightingElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:585692
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:586325
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEDiffuseLightingElement")
public class SVGFEDiffuseLightingElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
    ...
    */
    ...
    @JsProperty( name = "diffuseConstant")
    public native void setDiffuseConstant( SVGAnimatedNumber value );
