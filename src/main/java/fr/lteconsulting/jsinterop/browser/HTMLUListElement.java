...
/** 
  * base type: HTMLUListElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:485750
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:486132
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLUListElement")
public class HTMLUListElement implements HTMLElement
{
