...
/** 
  * base type: AesCbcParams
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:741296
  * 
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="AesCbcParams")
public class AesCbcParams extends Algorithm
{
