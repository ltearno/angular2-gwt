...
/** 
  * base type: SVGDefsElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:575237
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:575580
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGDefsElement")
public class SVGDefsElement implements SVGGraphicsElement
{
