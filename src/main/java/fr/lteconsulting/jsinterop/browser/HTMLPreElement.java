...
/** 
  * base type: HTMLPreElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:458499
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:458977
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLPreElement")
public class HTMLPreElement implements HTMLElement
{
