...
/** 
  * base type: SVGScriptElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:627028
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:627402
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGScriptElement")
public class SVGScriptElement implements SVGElement, SVGURIReference
{
