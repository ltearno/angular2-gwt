...
/** 
  * base type: HTMLTemplateElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:479407
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:479795
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLTemplateElement")
public class HTMLTemplateElement implements HTMLElement
{
