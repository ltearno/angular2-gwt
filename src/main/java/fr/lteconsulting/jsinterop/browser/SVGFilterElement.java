...
/** 
  * base type: SVGFilterElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:598132
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:598908
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFilterElement")
public class SVGFilterElement extends SVGUnitTypes implements SVGElement, SVGURIReference
{
    ...
    */
    ...
    /** 
      * Std Signature : S(setFilterRes,289,,P(d2),P(d2))
      * TE Signature : S(setFilterRes,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@598559
     */
    public native void setFilterRes(Number filterResX, Number filterResY);
    /** 
