...
/** 
  * base type: Int32Array
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:135921
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:148942
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:226814
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:254369
  * base type: Int32Array
  * flags: 16384
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:135921
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:148942
...
public class Int32Array
{
    ...
    */
    ...
    public Int32Array(ArrayBuffer buffer, Number byteOffset, Number length){
    }
    ...
    */
    /** 
      ...
      * source : apis/browser-api/tsd/lib.es6.d.ts:148474
     */
    @JsMethod(namespace="Int32Array", name = "of")
    public static native Int32Array of(Number... items);
    /** 
      * Creates an array from an array-like or iterable object.
      * Creates an array from an array-like or iterable object.
      * source : apis/browser-api/tsd/lib.es6.d.ts:148822
     */
    ...
    /** 
      ...
      * Creates an array from an array-like or iterable object.
      * source : apis/browser-api/tsd/lib.es6.d.ts:148822
      * source : apis/browser-api/tsd/lib.es6.d.ts:227818
     */
    @JsMethod(namespace="Int32Array", name = "from")
    ...
    */
    ...
    /** 
      * Std Signature : S(copyWithin,33,,P(d2),P(d2))
      * TE Signature : S(copyWithin,P(d2),P(d2))
      * 
     */
    public native Int32Array copyWithin(Number target, Number start);
    /** 
      * Std Signature : S(copyWithin,33,,P(d2),P(d2),P(d2))
      * TE Signature : S(copyWithin,P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@137055
      * Returns the this object after copying a section of the array identified by start and end
      * to the same array starting at position target
     */
    public native Int32Array copyWithin(Number target, Number start, Number end /* optional */);
    /** 
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@227166
      * Returns an array of key, value pairs for every entry in the array
     */
    public native IterableIterator<Tuple<Number, Number>> entries();
    /** 
      * Std Signature : S(every,27,,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<2,7,33,27>))
      * TE Signature : S(every,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@137618
      * Determines whether all the members of an array satisfy the specified test.
     */
    public native Boolean every(Function3<Number, Number, Int32Array, Boolean> callbackfn);
    /** 
      * Std Signature : S(fill,33,,P(d2))
      * TE Signature : S(fill,P(d2))
      * 
     */
    public native Int32Array fill(Number value);
    /** 
      * Std Signature : S(fill,33,,P(d2),P(d2))
      * TE Signature : S(fill,P(d2),P(d2))
      * 
     */
    public native Int32Array fill(Number value, Number start /* optional */);
    /** 
      * Std Signature : S(fill,33,,P(d2),P(d2),P(d2))
      * TE Signature : S(fill,P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@138181
      * Returns the this object after filling the section identified by start and end with value
     */
    public native Int32Array fill(Number value, Number start /* optional */, Number end /* optional */);
    /** 
      * Std Signature : S(filter,33,,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<2,7,33,3>))
      * TE Signature : S(filter,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@138693
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@139376
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@140065
      * Returns the index of the first element in the array where predicate is true, and -1
      * otherwise.
     */
    public native Number findIndex(Function3<Number, Number, Array<Number>, Boolean> predicate);
    /** 
      * Std Signature : S(forEach,289,,P(dFP1-,P2-,P3--S(?,289,,P(d3),P(d4),P(d5))------)<2,7,33>))
      * TE Signature : S(forEach,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@140589
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@140984
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@141334
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@227280
    ...
    /** 
      * Std Signature : S(reduce,2,,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<2,8,8,33,8>),P(d2))
      * TE Signature : S(reduce,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@143055
      ...
      * call to the callback function.
     */
    public native Number reduce(Function4<Number, Number, Number, Int32Array, Number> callbackfn, Number initialValue /* optional */);
    /** 
      * Std Signature : S(reduce,U-,U-,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<U-,2,9,33,8>),P(dU-))
      * TE Signature : S(reduce,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@143870
      * Calls the specified callback function for all the elements in an array. The return value of
      * the callback function is the accumulated result, and is provided as an argument in the next
      * call to the callback function.
      * Calls the specified callback function for all the elements in an array. The return value of
      ...
      * VERSION 1
     */
    public native <U> U reduce(Function4<U, Number, Number, Int32Array, U> callbackfn, U initialValue);
    /** 
      * Std Signature : S(reduceRight,2,,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<2,8,8,33,8>))
    ...
    /** 
      * Std Signature : S(reduceRight,2,,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<2,8,8,33,8>),P(d2))
      * TE Signature : S(reduceRight,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@144693
      ...
      * argument in the next call to the callback function.
     */
    public native Number reduceRight(Function4<Number, Number, Number, Int32Array, Number> callbackfn, Number initialValue /* optional */);
    /** 
      * Std Signature : S(reduceRight,U-,U-,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<U-,2,9,33,8>),P(dU-))
      * TE Signature : S(reduceRight,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@145539
      * Calls the specified callback function for all the elements in an array, in descending order.
      * The return value of the callback function is the accumulated result, and is provided as an
      * argument in the next call to the callback function.
      * Calls the specified callback function for all the elements in an array, in descending order.
      ...
      * VERSION 1
     */
    public native <U> U reduceRight(Function4<U, Number, Number, Int32Array, U> callbackfn, U initialValue);
    /** 
      * Std Signature : S(reverse,33,,)
      * TE Signature : S(reverse,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@145740
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@145923
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@146186
      * Sets a value or an array of values.
      * Sets a value or an array of values.
      * VERSION 1
     */
    ...
    /** 
      * Std Signature : S(slice,33,,)
      * TE Signature : S(slice,)
      * 
     */
    public native Int32Array slice();
    /** 
      * Std Signature : S(slice,33,,P(d2))
      * TE Signature : S(slice,P(d2))
      * 
     */
    public native Int32Array slice(Number start /* optional */);
    /** 
      * Std Signature : S(slice,33,,P(d2),P(d2))
      * TE Signature : S(slice,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@146441
      * Returns a section of an array.
     */
    public native Int32Array slice(Number start /* optional */, Number end /* optional */);
    /** 
      * Std Signature : S(some,27,,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<2,7,33,27>))
      * TE Signature : S(some,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@147006
      * Determines whether the specified callback function returns true for any element of an array.
     */
    public native Boolean some(Function3<Number, Number, Int32Array, Boolean> callbackfn);
    /** 
      * Std Signature : S(sort,33,,)
      * TE Signature : S(sort,)
      * 
     */
    public native Int32Array sort();
    /** 
      * Std Signature : S(sort,33,,P(dFP1-,P2-,R--S(?,5,,P(d3),P(d4))------)<2,6,6>))
      * TE Signature : S(sort,P(dF--S(?,P(d3),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@147332
      * Sorts an array.
     */
    public native Int32Array sort(Function2<Number, Number, Number> compareFn /* optional */);
    /** 
      * Std Signature : S(subarray,33,,P(d2))
      * TE Signature : S(subarray,P(d2))
      * 
     */
    public native Int32Array subarray(Number begin);
    /** 
      * Std Signature : S(subarray,33,,P(d2),P(d2))
      * TE Signature : S(subarray,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@147680
      * Gets a new Int32Array view of the ArrayBuffer store for this array, referencing the elements
      * at begin, inclusive, up to end, exclusive.
     */
    public native Int32Array subarray(Number begin, Number end /* optional */);
    /** 
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@147820
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@227383
