...
/** 
  * base type: SVGFECompositeElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:582827
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:583848
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFECompositeElement")
public class SVGFECompositeElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
