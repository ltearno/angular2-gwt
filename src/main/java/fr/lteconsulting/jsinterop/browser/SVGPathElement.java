...
/** 
  * base type: SVGPathElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:609087
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:611536
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGPathElement")
public class SVGPathElement implements SVGGraphicsElement
{
    ...
    */
    ...
    /** 
      * Std Signature : S(createSVGPathSegArcAbs,432,,P(d2),P(d2),P(d2),P(d2),P(d2),P(d27),P(d27))
      * TE Signature : S(createSVGPathSegArcAbs,P(d2),P(d2),P(d2),P(d2),P(d2),P(d27),P(d27))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@609189
     */
    public native SVGPathSegArcAbs createSVGPathSegArcAbs(Number x, Number y, Number r1, Number r2, Number angle, Boolean largeArcFlag, Boolean sweepFlag);
    /** 
      * Std Signature : S(createSVGPathSegArcRel,433,,P(d2),P(d2),P(d2),P(d2),P(d2),P(d27),P(d27))
      * TE Signature : S(createSVGPathSegArcRel,P(d2),P(d2),P(d2),P(d2),P(d2),P(d27),P(d27))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@609339
     */
    public native SVGPathSegArcRel createSVGPathSegArcRel(Number x, Number y, Number r1, Number r2, Number angle, Boolean largeArcFlag, Boolean sweepFlag);
    /** 
      * Std Signature : S(createSVGPathSegClosePath,434,,)
      * TE Signature : S(createSVGPathSegClosePath,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@609489
     */
    public native SVGPathSegClosePath createSVGPathSegClosePath();
    /** 
      * Std Signature : S(createSVGPathSegCurvetoCubicAbs,435,,P(d2),P(d2),P(d2),P(d2),P(d2),P(d2))
      * TE Signature : S(createSVGPathSegCurvetoCubicAbs,P(d2),P(d2),P(d2),P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@609543
     */
    public native SVGPathSegCurvetoCubicAbs createSVGPathSegCurvetoCubicAbs(Number x, Number y, Number x1, Number y1, Number x2, Number y2);
    /** 
      * Std Signature : S(createSVGPathSegCurvetoCubicRel,436,,P(d2),P(d2),P(d2),P(d2),P(d2),P(d2))
      * TE Signature : S(createSVGPathSegCurvetoCubicRel,P(d2),P(d2),P(d2),P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@609677
     */
    public native SVGPathSegCurvetoCubicRel createSVGPathSegCurvetoCubicRel(Number x, Number y, Number x1, Number y1, Number x2, Number y2);
    /** 
      * Std Signature : S(createSVGPathSegCurvetoCubicSmoothAbs,437,,P(d2),P(d2),P(d2),P(d2))
      * TE Signature : S(createSVGPathSegCurvetoCubicSmoothAbs,P(d2),P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@609811
     */
    public native SVGPathSegCurvetoCubicSmoothAbs createSVGPathSegCurvetoCubicSmoothAbs(Number x, Number y, Number x2, Number y2);
    /** 
      * Std Signature : S(createSVGPathSegCurvetoCubicSmoothRel,438,,P(d2),P(d2),P(d2),P(d2))
      * TE Signature : S(createSVGPathSegCurvetoCubicSmoothRel,P(d2),P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@609933
     */
    public native SVGPathSegCurvetoCubicSmoothRel createSVGPathSegCurvetoCubicSmoothRel(Number x, Number y, Number x2, Number y2);
    /** 
      * Std Signature : S(createSVGPathSegCurvetoQuadraticAbs,439,,P(d2),P(d2),P(d2),P(d2))
      * TE Signature : S(createSVGPathSegCurvetoQuadraticAbs,P(d2),P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610055
     */
    public native SVGPathSegCurvetoQuadraticAbs createSVGPathSegCurvetoQuadraticAbs(Number x, Number y, Number x1, Number y1);
    /** 
      * Std Signature : S(createSVGPathSegCurvetoQuadraticRel,440,,P(d2),P(d2),P(d2),P(d2))
      * TE Signature : S(createSVGPathSegCurvetoQuadraticRel,P(d2),P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610173
     */
    public native SVGPathSegCurvetoQuadraticRel createSVGPathSegCurvetoQuadraticRel(Number x, Number y, Number x1, Number y1);
    /** 
      * Std Signature : S(createSVGPathSegCurvetoQuadraticSmoothAbs,441,,P(d2),P(d2))
      * TE Signature : S(createSVGPathSegCurvetoQuadraticSmoothAbs,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610291
     */
    public native SVGPathSegCurvetoQuadraticSmoothAbs createSVGPathSegCurvetoQuadraticSmoothAbs(Number x, Number y);
    /** 
      * Std Signature : S(createSVGPathSegCurvetoQuadraticSmoothRel,442,,P(d2),P(d2))
      * TE Signature : S(createSVGPathSegCurvetoQuadraticSmoothRel,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610397
     */
    public native SVGPathSegCurvetoQuadraticSmoothRel createSVGPathSegCurvetoQuadraticSmoothRel(Number x, Number y);
    /** 
      * Std Signature : S(createSVGPathSegLinetoAbs,443,,P(d2),P(d2))
      * TE Signature : S(createSVGPathSegLinetoAbs,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610503
     */
    public native SVGPathSegLinetoAbs createSVGPathSegLinetoAbs(Number x, Number y);
    /** 
      * Std Signature : S(createSVGPathSegLinetoHorizontalAbs,444,,P(d2))
      * TE Signature : S(createSVGPathSegLinetoHorizontalAbs,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610577
     */
    public native SVGPathSegLinetoHorizontalAbs createSVGPathSegLinetoHorizontalAbs(Number x);
    /** 
      * Std Signature : S(createSVGPathSegLinetoHorizontalRel,445,,P(d2))
      * TE Signature : S(createSVGPathSegLinetoHorizontalRel,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610660
     */
    public native SVGPathSegLinetoHorizontalRel createSVGPathSegLinetoHorizontalRel(Number x);
    /** 
      * Std Signature : S(createSVGPathSegLinetoRel,446,,P(d2),P(d2))
      * TE Signature : S(createSVGPathSegLinetoRel,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610743
     */
    public native SVGPathSegLinetoRel createSVGPathSegLinetoRel(Number x, Number y);
    /** 
      * Std Signature : S(createSVGPathSegLinetoVerticalAbs,447,,P(d2))
      * TE Signature : S(createSVGPathSegLinetoVerticalAbs,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610817
     */
    public native SVGPathSegLinetoVerticalAbs createSVGPathSegLinetoVerticalAbs(Number y);
    /** 
      * Std Signature : S(createSVGPathSegLinetoVerticalRel,448,,P(d2))
      * TE Signature : S(createSVGPathSegLinetoVerticalRel,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610896
     */
    public native SVGPathSegLinetoVerticalRel createSVGPathSegLinetoVerticalRel(Number y);
    /** 
      * Std Signature : S(createSVGPathSegMovetoAbs,449,,P(d2),P(d2))
      * TE Signature : S(createSVGPathSegMovetoAbs,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@610975
     */
    public native SVGPathSegMovetoAbs createSVGPathSegMovetoAbs(Number x, Number y);
    /** 
      * Std Signature : S(createSVGPathSegMovetoRel,450,,P(d2),P(d2))
      * TE Signature : S(createSVGPathSegMovetoRel,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@611049
     */
    public native SVGPathSegMovetoRel createSVGPathSegMovetoRel(Number x, Number y);
    /** 
    ...
    /** 
      * Std Signature : S(getPathSegAtLength,2,,P(d2))
      * TE Signature : S(getPathSegAtLength,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@611123
     */
    public native Number getPathSegAtLength(Number distance);
    /** 
      * Std Signature : S(getPointAtLength,120,,P(d2))
      * TE Signature : S(getPointAtLength,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@611173
     */
    public native SVGPoint getPointAtLength(Number distance);
    /** 
    ...
    /** 
      * Std Signature : S(getTotalLength,2,,)
      * TE Signature : S(getTotalLength,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@611223
     */
