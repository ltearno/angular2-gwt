...
/** 
  * base type: HTMLBodyElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:387829
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:389535
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLBodyElement")
public class HTMLBodyElement implements HTMLElement
{
    ...
    */
    ...
    public native Object getALink();

    @JsProperty( name = "aLink")
    public native void setALink( Object value );
    ...
    public native String getBgProperties();

    @JsProperty( name = "bgProperties")
    public native void setBgProperties( String value );
    ...
    public native Object getLink();

    @JsProperty( name = "link")
    public native void setLink( Object value );
    ...
    @JsProperty( name = "text")
    public native void setText( Object value );
    ...
    public native Object getVLink();

    @JsProperty( name = "vLink")
    public native void setVLink( Object value );
