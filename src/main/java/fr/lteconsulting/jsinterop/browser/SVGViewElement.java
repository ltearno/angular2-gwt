...
/** 
  * base type: SVGViewElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:636766
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:637173
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGViewElement")
public class SVGViewElement implements SVGElement, SVGZoomAndPan, SVGFitToViewBox
{
