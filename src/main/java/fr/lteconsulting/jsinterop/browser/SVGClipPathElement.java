...
/** 
  * base type: SVGClipPathElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:573211
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:573628
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGClipPathElement")
public class SVGClipPathElement extends SVGUnitTypes implements SVGGraphicsElement
{
