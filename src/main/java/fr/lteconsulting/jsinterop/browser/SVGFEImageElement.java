...
/** 
  * base type: SVGFEImageElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:591083
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:591545
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEImageElement")
public class SVGFEImageElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement, SVGURIReference
{
