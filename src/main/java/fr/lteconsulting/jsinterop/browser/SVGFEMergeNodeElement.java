...
/** 
  * base type: SVGFEMergeNodeElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:592098
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:592484
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEMergeNodeElement")
public class SVGFEMergeNodeElement implements SVGElement
{
