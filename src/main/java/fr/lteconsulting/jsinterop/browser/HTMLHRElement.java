...
/** 
  * base type: HTMLHRElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:417601
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:418311
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLHRElement")
public class HTMLHRElement implements HTMLElement, DOML2DeprecatedColorProperty, DOML2DeprecatedSizeProperty
{
