...
/** 
  * base type: HTMLOptionElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:454111
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:455336
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLOptionElement")
public class HTMLOptionElement implements HTMLElement
{
