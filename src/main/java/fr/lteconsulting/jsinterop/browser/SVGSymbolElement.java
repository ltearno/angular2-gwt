...
/** 
  * base type: SVGSymbolElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:629315
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:629671
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGSymbolElement")
public class SVGSymbolElement implements SVGElement, SVGFitToViewBox
{
