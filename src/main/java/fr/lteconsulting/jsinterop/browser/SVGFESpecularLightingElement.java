...
/** 
  * base type: SVGFESpecularLightingElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:594696
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:595382
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFESpecularLightingElement")
public class SVGFESpecularLightingElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
    ...
    */
    ...
    @JsProperty( name = "specularConstant")
    public native void setSpecularConstant( SVGAnimatedNumber value );
    ...
    @JsProperty( name = "surfaceScale")
    public native void setSurfaceScale( SVGAnimatedNumber value );
