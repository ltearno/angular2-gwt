...
/** 
  * base type: HTMLMenuElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:445243
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:445623
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLMenuElement")
public class HTMLMenuElement implements HTMLElement
{
