...
/** 
  * base type: HTMLBaseFontElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:386588
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:387146
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLBaseFontElement")
public class HTMLBaseFontElement implements HTMLElement, DOML2DeprecatedColorProperty
{
