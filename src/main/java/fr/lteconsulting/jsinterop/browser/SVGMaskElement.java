...
/** 
  * base type: SVGMaskElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:606718
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:607329
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGMaskElement")
public class SVGMaskElement extends SVGUnitTypes implements SVGElement, SVGTests
{
