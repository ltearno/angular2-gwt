...
/** 
  * base type: HTMLTitleElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:484411
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:484851
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLTitleElement")
public class HTMLTitleElement implements HTMLElement
{
