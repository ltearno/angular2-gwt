...
/** 
  * base type: SVGFEBlendElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:578879
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:580190
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEBlendElement")
public class SVGFEBlendElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
