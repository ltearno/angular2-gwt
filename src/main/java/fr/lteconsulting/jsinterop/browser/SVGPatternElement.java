...
/** 
  * base type: SVGPatternElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:618639
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:619353
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGPatternElement")
public class SVGPatternElement extends SVGUnitTypes implements SVGElement, SVGTests, SVGFitToViewBox, SVGURIReference
{
