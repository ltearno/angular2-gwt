...
/** 
  * base type: BiquadFilterNode
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:292600
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:292924
  * 1 constructors
 */
...
public class BiquadFilterNode extends AudioNode
{
    ...
    */
    ...
    /** 
      * Std Signature : S(getFrequencyResponse,289,,P(d35),P(d35),P(d35))
      * TE Signature : S(getFrequencyResponse,P(d35),P(d35),P(d35))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@292799
     */
