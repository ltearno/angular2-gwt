...
/** 
  * base type: HTMLImageElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:422514
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:425080
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLImageElement")
public class HTMLImageElement implements HTMLElement
{
    ...
    */
    ...
    @JsProperty( name = "naturalHeight")
    public native void setNaturalHeight( Number value );
    ...
    @JsProperty( name = "naturalWidth")
    public native void setNaturalWidth( Number value );
    ...
    */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@424760
     */
