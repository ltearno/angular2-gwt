...
/** 
  * base type: HTMLCanvasElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:392612
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:394699
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLCanvasElement")
public class HTMLCanvasElement implements HTMLElement
{
    ...
    */
    ...
    /** 
      * Std Signature : S(getContext,357,,P(d1))
      * TE Signature : S(getContext,P(d1))
      * 
     */
    public native CanvasRenderingContext2D getContext(String contextId);
    /** 
      * Std Signature : S(getContext,357,,P(d1),P(d222))
      * TE Signature : S(getContext,P(d1),P(d222))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@393446
    ...
    /** 
      * Std Signature : S(getContext,358,,P(d1),P(d234))
      * TE Signature : S(getContext,P(d1),P(d234))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@393559
      * Returns an object that provides methods and properties for drawing and manipulating images and graphics on a canvas element in a document. A context object includes information about colors, line widths, fonts, and other graphic parameters that can be drawn on a canvas.
      * VERSION 1
     */
    public native WebGLRenderingContext getContext(String contextId, WebGLContextAttributes contextAttributes /* optional */);
    /** 
      * Std Signature : S(getContext,U(-357,358),,P(d1),P(d3))
      * TE Signature : S(getContext,P(d1),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@393692
      * Returns an object that provides methods and properties for drawing and manipulating images and graphics on a canvas element in a document. A context object includes information about colors, line widths, fonts, and other graphic parameters that can be drawn on a canvas.
      * VERSION 2
     */
    ...
    /** 
      * Std Signature : S(msToBlob,235,,)
      * TE Signature : S(msToBlob,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@393939
    ...
    /** 
      * Std Signature : S(toBlob,289,,P(dFP1--S(?,289,,P(d3))------)<235>))
      * TE Signature : S(toBlob,P(dF--S(?,P(d3))------)))
      * 
     */
    public native void toBlob(Action1<Blob> callback);
    /** 
      * Std Signature : S(toBlob,289,,P(dFP1--S(?,289,,P(d3))------)<235>),P(d1))
      * TE Signature : S(toBlob,P(dF--S(?,P(d3))------)),P(d1))
      * 
     */
    public native void toBlob(Action1<Blob> callback, String type /* optional */);
    /** 
      * Std Signature : S(toBlob,289,,P(dFP1--S(?,289,,P(d3))------)<235>),P(d1),P(D3))
      * TE Signature : S(toBlob,P(dF--S(?,P(d3))------)),P(d1),P(D3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@394316
     */
    public native void toBlob(Action1<Blob> callback, String type /* optional */, Object... arguments);
    /** 
      * Std Signature : S(toDataURL,1,,)
      * TE Signature : S(toDataURL,)
      * 
     */
    public native String toDataURL();
    /** 
      * Std Signature : S(toDataURL,1,,P(d1))
      * TE Signature : S(toDataURL,P(d1))
      * 
     */
    public native String toDataURL(String type /* optional */);
    /** 
      * Std Signature : S(toDataURL,1,,P(d1),P(D3))
      * TE Signature : S(toDataURL,P(d1),P(D3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@394262
