...
/** 
  * base type: SVGPolygonElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:620081
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:620449
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGPolygonElement")
public class SVGPolygonElement extends SVGAnimatedPoints implements SVGGraphicsElement
{
