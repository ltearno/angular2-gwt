...
/** 
  * base type: HTMLEmbedElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:405132
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:406865
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLEmbedElement")
public class HTMLEmbedElement implements HTMLElement, GetSVGDocument
{
