...
/** 
  * base type: SVGFEOffsetElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:593558
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:594048
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEOffsetElement")
public class SVGFEOffsetElement extends SVGFilterPrimitiveStandardAttributes implements SVGElement
{
    ...
    */
    ...
    @JsProperty( name = "dx")
    public native void setDx( SVGAnimatedNumber value );
    ...
    @JsProperty( name = "dy")
    public native void setDy( SVGAnimatedNumber value );
