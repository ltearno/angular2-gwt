...
/** 
  * base type: HTMLSpanElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:467310
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:467650
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLSpanElement")
public class HTMLSpanElement implements HTMLElement
{
