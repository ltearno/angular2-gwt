...
/** 
  * base type: HTMLHeadElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:418386
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:418747
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLHeadElement")
public class HTMLHeadElement implements HTMLElement
{
