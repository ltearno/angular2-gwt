...
/** 
  * base type: SVGGElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:599607
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:599944
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGGElement")
public class SVGGElement implements SVGGraphicsElement
{
