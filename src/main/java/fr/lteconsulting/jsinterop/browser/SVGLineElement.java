...
/** 
  * base type: SVGLineElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:604138
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:604625
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGLineElement")
public class SVGLineElement implements SVGGraphicsElement
{
