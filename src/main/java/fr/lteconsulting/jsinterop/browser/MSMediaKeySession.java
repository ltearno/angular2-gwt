...
/** 
  * base type: MSMediaKeySession
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:511332
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:511560
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="MSMediaKeySession")
public class MSMediaKeySession implements EventTarget
{
    ...
    */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@511496
     */
    ...
    /** 
      * Std Signature : S(update,289,,P(d29))
      * TE Signature : S(update,P(d29))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@511515
     */
