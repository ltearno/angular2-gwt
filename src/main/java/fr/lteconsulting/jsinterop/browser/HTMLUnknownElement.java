...
/** 
  * base type: HTMLUnknownElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:486216
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:486562
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLUnknownElement")
public class HTMLUnknownElement implements HTMLElement
{
