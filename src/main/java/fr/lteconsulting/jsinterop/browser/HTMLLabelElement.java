...
/** 
  * base type: HTMLLabelElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:433715
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:434304
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLLabelElement")
public class HTMLLabelElement implements HTMLElement
{
