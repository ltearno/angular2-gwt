...
/** 
  * base type: MediaDevices
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:516547
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:517112
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="MediaDevices")
public class MediaDevices implements EventTarget
{
    ...
    */
    ...
    /** 
      * Std Signature : S(enumerateDevices,3,,)
      * TE Signature : S(enumerateDevices,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@516658
     */
    public native Object enumerateDevices();
    /** 
      * Std Signature : S(getSupportedConstraints,481,,)
      * TE Signature : S(getSupportedConstraints,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@516687
     */
    public native MediaTrackSupportedConstraints getSupportedConstraints();
    /** 
      * Std Signature : S(getUserMedia,88<79>,,P(d156))
      * TE Signature : S(getUserMedia,P(d156))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@516750
     */
