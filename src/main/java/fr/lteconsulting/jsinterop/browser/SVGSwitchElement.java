...
/** 
  * base type: SVGSwitchElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:628884
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:629231
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGSwitchElement")
public class SVGSwitchElement implements SVGGraphicsElement
{
