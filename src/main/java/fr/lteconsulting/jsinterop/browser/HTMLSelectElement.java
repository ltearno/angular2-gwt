...
/** 
  * base type: HTMLSelectElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:461892
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:466427
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLSelectElement")
public class HTMLSelectElement implements HTMLElement
{
    ...
    */
    /** 
      * Std Signature : S(add,289,,P(d240))
      * TE Signature : S(add,P(d240))
      * 
     */
    public native void add(HTMLElement element);
    /** 
      * Std Signature : S(add,289,,P(d240),P(d2))
      * TE Signature : S(add,P(d240),P(d2))
      * 
     */
    public native void add(HTMLElement element, Number before /* optional */);
    /** 
      * Std Signature : S(add,289,,P(d240),P(d240))
      * TE Signature : S(add,P(d240),P(d240))
      * 
     */
    public native void add(HTMLElement element, HTMLElement before /* optional */);
    /** 
      * Std Signature : S(add,289,,P(d240),P(dU(-240,2)))
      * TE Signature : S(add,P(d240),P(dU(-240,2)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@464572
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@464753
    ...
    /** 
      * Std Signature : S(item,3,,)
      * TE Signature : S(item,)
      * 
     */
    public native Object item();
    /** 
      * Std Signature : S(item,3,,P(d3))
      * TE Signature : S(item,P(d3))
      * 
     */
    public native Object item(Object name /* optional */);
    /** 
      * Std Signature : S(item,3,,P(d3),P(d3))
      * TE Signature : S(item,P(d3),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@465348
    ...
    /** 
      * Std Signature : S(namedItem,3,,P(d1))
      * TE Signature : S(namedItem,P(d1))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@465637
      * Retrieves a select object or an object from an options collection.
     */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@465846
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@466070
