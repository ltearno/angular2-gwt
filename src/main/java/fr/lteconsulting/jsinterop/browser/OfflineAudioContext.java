...
/** 
  * base type: OfflineAudioContext
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:538191
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:538767
  * 1 constructors
 */
...
public class OfflineAudioContext extends AudioContextBase
{
    ...
    /*
        Constructors
    */
    public OfflineAudioContext(Number numberOfChannels, Number length, Number sampleRate){
    }
    ...
    */
    ...
    /** 
      * Std Signature : S(startRendering,88<218>,,)
      * TE Signature : S(startRendering,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@538368
     */
    public native Promise<AudioBuffer> startRendering();
    /** 
      * Std Signature : S(suspend,88<369>,,P(d2))
      * TE Signature : S(suspend,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@538412
     */
    public native Promise<Void> suspend(Number suspendTime);
}
