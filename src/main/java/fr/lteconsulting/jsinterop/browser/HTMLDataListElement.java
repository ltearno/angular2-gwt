...
/** 
  * base type: HTMLDataListElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:396239
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:396637
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLDataListElement")
public class HTMLDataListElement implements HTMLElement
{
