...
/** 
  * base type: HTMLAnchorElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:377975
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:380305
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLAnchorElement")
public class HTMLAnchorElement implements HTMLElement
{
