...
/** 
  * base type: HTMLIFrameElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:419994
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:422427
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLIFrameElement")
public class HTMLIFrameElement implements HTMLElement, GetSVGDocument
{
