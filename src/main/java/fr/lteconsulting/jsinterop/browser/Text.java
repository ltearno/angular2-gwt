...
/** 
  * base type: Text
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:653132
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:653307
  * 1 constructors
 */
...
public class Text extends CharacterData
{
    ...
    */
    ...
    /** 
      * Std Signature : S(splitText,394,,P(d2))
      * TE Signature : S(splitText,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@653260
     */
    public native Text splitText(Number offset);
}
