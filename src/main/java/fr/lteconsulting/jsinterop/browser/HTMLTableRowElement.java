...
/** 
  * base type: HTMLTableRowElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:476341
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:477996
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLTableRowElement")
public class HTMLTableRowElement extends HTMLTableAlignment implements HTMLElement
{
    ...
    */
    ...
    @JsProperty( name = "rowIndex")
    public native void setRowIndex( Number value );
    ...
    @JsProperty( name = "sectionRowIndex")
    public native void setSectionRowIndex( Number value );
    ...
    */
    ...
    /** 
      * Std Signature : S(deleteCell,289,,)
      * TE Signature : S(deleteCell,)
      * 
     */
    public native void deleteCell();
    /** 
      * Std Signature : S(deleteCell,289,,P(d2))
      * TE Signature : S(deleteCell,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@477338
      * Removes the specified cell from the table row, as well as from the cells collection.
     */
    public native void deleteCell(Number index /* optional */);
    /** 
    ...
    /** 
      * Std Signature : S(insertCell,361,,)
      * TE Signature : S(insertCell,)
      * 
     */
    public native HTMLTableDataCellElement insertCell();
    /** 
      * Std Signature : S(insertCell,361,,P(d2))
      * TE Signature : S(insertCell,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@477648
      * Creates a new cell in the table row, and adds the cell to the cells collection.
     */
    public native HTMLTableDataCellElement insertCell(Number index /* optional */);
    /** 
