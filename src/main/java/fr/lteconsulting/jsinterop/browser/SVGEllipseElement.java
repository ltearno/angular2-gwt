...
/** 
  * base type: SVGEllipseElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:578299
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:578792
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGEllipseElement")
public class SVGEllipseElement implements SVGGraphicsElement
{
