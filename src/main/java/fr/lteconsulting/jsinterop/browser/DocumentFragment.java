...
/** 
  * base type: DocumentFragment
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:363376
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:363460
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="DocumentFragment")
public class DocumentFragment implements Node, NodeSelector, ParentNode
{
