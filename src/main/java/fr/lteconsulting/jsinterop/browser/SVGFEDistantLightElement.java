...
/** 
  * base type: SVGFEDistantLightElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:587553
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:587992
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGFEDistantLightElement")
public class SVGFEDistantLightElement implements SVGElement
{
