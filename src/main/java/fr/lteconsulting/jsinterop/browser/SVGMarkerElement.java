...
/** 
  * base type: SVGMarkerElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:605318
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:606346
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGMarkerElement")
public class SVGMarkerElement implements SVGElement, SVGFitToViewBox
{
    ...
    */
    ...
    /** 
      * Std Signature : S(setOrientToAngle,289,,P(d129))
      * TE Signature : S(setOrientToAngle,P(d129))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@605699
     */
    public native void setOrientToAngle(SVGAngle angle);
    /** 
      * Std Signature : S(setOrientToAuto,289,,)
      * TE Signature : S(setOrientToAuto,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@605744
     */
