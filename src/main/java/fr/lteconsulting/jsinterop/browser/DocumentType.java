...
/** 
  ...
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:363544
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:363817
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="DocumentType")
public class DocumentType implements Node, ChildNode
{
