...
/** 
  * base type: MSHTMLWebViewElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:506088
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:507578
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="MSHTMLWebViewElement")
public class MSHTMLWebViewElement implements HTMLElement
{
    ...
    */
    ...
    /** 
      * Std Signature : S(addWebAllowedObject,289,,P(d1),P(d3))
      * TE Signature : S(addWebAllowedObject,P(d1),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506399
     */
    ...
    /** 
      * Std Signature : S(buildLocalStreamUri,1,,P(d1),P(d1))
      * TE Signature : S(buildLocalStreamUri,P(d1),P(d1))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506468
     */
    public native String buildLocalStreamUri(String contentIdentifier, String relativePath);
    /** 
      * Std Signature : S(capturePreviewToBlobAsync,561,,)
      * TE Signature : S(capturePreviewToBlobAsync,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506550
     */
    public native MSWebViewAsyncOperation capturePreviewToBlobAsync();
    /** 
      * Std Signature : S(captureSelectedContentToDataPackageAsync,561,,)
      * TE Signature : S(captureSelectedContentToDataPackageAsync,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506608
     */
    ...
    /** 
      * Std Signature : S(getDeferredPermissionRequestById,562,,P(d2))
      * TE Signature : S(getDeferredPermissionRequestById,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506681
     */
    public native DeferredPermissionRequest getDeferredPermissionRequestById(Number id);
    /** 
      * Std Signature : S(getDeferredPermissionRequests,7<562>,,)
      * TE Signature : S(getDeferredPermissionRequests,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506758
     */
    ...
    /** 
      * Std Signature : S(goBack,289,,)
      * TE Signature : S(goBack,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506824
     */
    public native void goBack();
    /** 
      * Std Signature : S(goForward,289,,)
      * TE Signature : S(goForward,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506844
     */
    ...
    /** 
      * Std Signature : S(invokeScriptAsync,561,,P(d1))
      * TE Signature : S(invokeScriptAsync,P(d1))
      * 
     */
    public native MSWebViewAsyncOperation invokeScriptAsync(String scriptName);
    /** 
      * Std Signature : S(invokeScriptAsync,561,,P(d1),P(D3))
      * TE Signature : S(invokeScriptAsync,P(d1),P(D3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506867
     */
    ...
    /** 
      * Std Signature : S(navigate,289,,P(d1))
      * TE Signature : S(navigate,P(d1))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506951
     */
    public native void navigate(String uri);
    /** 
      * Std Signature : S(navigateFocus,289,,P(d1),P(d207))
      * TE Signature : S(navigateFocus,P(d1),P(d207))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@506984
     */
    public native void navigateFocus(String navigationReason, FocusNavigationOrigin origin);
    /** 
      * Std Signature : S(navigateToLocalStreamUri,289,,P(d1),P(d3))
      * TE Signature : S(navigateToLocalStreamUri,P(d1),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@507066
     */
    public native void navigateToLocalStreamUri(String source, Object streamResolver);
    /** 
      * Std Signature : S(navigateToString,289,,P(d1))
      * TE Signature : S(navigateToString,P(d1))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@507139
     */
    public native void navigateToString(String contents);
    /** 
      * Std Signature : S(navigateWithHttpRequestMessage,289,,P(d3))
      * TE Signature : S(navigateWithHttpRequestMessage,P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@507185
     */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@507248
     */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@507269
     */
