...
/** 
  * base type: HmacKeyGenParams
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:741833
  * 
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HmacKeyGenParams")
public class HmacKeyGenParams extends Algorithm
{
