...
/** 
  * base type: HTMLScriptElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:460642
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:461805
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLScriptElement")
public class HTMLScriptElement implements HTMLElement
{
