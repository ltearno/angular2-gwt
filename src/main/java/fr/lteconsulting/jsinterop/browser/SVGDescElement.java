...
/** 
  * base type: SVGDescElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:575658
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:575993
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGDescElement")
public class SVGDescElement implements SVGElement
{
