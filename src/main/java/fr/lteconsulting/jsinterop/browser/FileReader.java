...
/** 
  * base type: FileReader
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:374838
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:375387
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="FileReader")
public class FileReader extends MSBaseReader implements EventTarget
{
    ...
    */
    ...
    /** 
      * Std Signature : S(readAsArrayBuffer,289,,P(d235))
      * TE Signature : S(readAsArrayBuffer,P(d235))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@374931
     */
    public native void readAsArrayBuffer(Blob blob);
    /** 
      * Std Signature : S(readAsBinaryString,289,,P(d235))
      * TE Signature : S(readAsBinaryString,P(d235))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@374972
     */
    public native void readAsBinaryString(Blob blob);
    /** 
      * Std Signature : S(readAsDataURL,289,,P(d235))
      * TE Signature : S(readAsDataURL,P(d235))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@375014
     */
    public native void readAsDataURL(Blob blob);
    /** 
      * Std Signature : S(readAsText,289,,P(d235))
      * TE Signature : S(readAsText,P(d235))
      * 
     */
    public native void readAsText(Blob blob);
    /** 
      * Std Signature : S(readAsText,289,,P(d235),P(d1))
      * TE Signature : S(readAsText,P(d235),P(d1))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@375051
     */
