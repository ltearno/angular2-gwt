...
/** 
  * base type: HTMLFontElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:408701
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:409190
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLFontElement")
public class HTMLFontElement implements HTMLElement, DOML2DeprecatedColorProperty, DOML2DeprecatedSizeProperty
{
