...
/** 
  * base type: Float32Array
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:162061
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:175121
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:229038
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:254883
  * base type: Float32Array
  * flags: 16384
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:162061
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:175121
...
public class Float32Array
{
    ...
    */
    ...
    public Float32Array(ArrayBuffer buffer, Number byteOffset, Number length){
    }
    ...
    */
    /** 
      ...
      * source : apis/browser-api/tsd/lib.es6.d.ts:174648
     */
    @JsMethod(namespace="Float32Array", name = "of")
    public static native Float32Array of(Number... items);
    /** 
      * Creates an array from an array-like or iterable object.
      * Creates an array from an array-like or iterable object.
      * source : apis/browser-api/tsd/lib.es6.d.ts:174998
     */
    ...
    /** 
      ...
      * Creates an array from an array-like or iterable object.
      * source : apis/browser-api/tsd/lib.es6.d.ts:174998
      * source : apis/browser-api/tsd/lib.es6.d.ts:230038
     */
    @JsMethod(namespace="Float32Array", name = "from")
    ...
    */
    ...
    /** 
      * Std Signature : S(copyWithin,35,,P(d2),P(d2))
      * TE Signature : S(copyWithin,P(d2),P(d2))
      * 
     */
    public native Float32Array copyWithin(Number target, Number start);
    /** 
      * Std Signature : S(copyWithin,35,,P(d2),P(d2),P(d2))
      * TE Signature : S(copyWithin,P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@163189
      * Returns the this object after copying a section of the array identified by start and end
      * to the same array starting at position target
     */
    public native Float32Array copyWithin(Number target, Number start, Number end /* optional */);
    /** 
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@229382
      * Returns an array of key, value pairs for every entry in the array
     */
    public native IterableIterator<Tuple<Number, Number>> entries();
    /** 
      * Std Signature : S(every,27,,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<2,7,35,27>))
      * TE Signature : S(every,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@163752
      * Determines whether all the members of an array satisfy the specified test.
     */
    public native Boolean every(Function3<Number, Number, Float32Array, Boolean> callbackfn);
    /** 
      * Std Signature : S(fill,35,,P(d2))
      * TE Signature : S(fill,P(d2))
      * 
     */
    public native Float32Array fill(Number value);
    /** 
      * Std Signature : S(fill,35,,P(d2),P(d2))
      * TE Signature : S(fill,P(d2),P(d2))
      * 
     */
    public native Float32Array fill(Number value, Number start /* optional */);
    /** 
      * Std Signature : S(fill,35,,P(d2),P(d2),P(d2))
      * TE Signature : S(fill,P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@164317
      * Returns the this object after filling the section identified by start and end with value
     */
    public native Float32Array fill(Number value, Number start /* optional */, Number end /* optional */);
    /** 
      * Std Signature : S(filter,35,,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<2,7,35,3>))
      * TE Signature : S(filter,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@164829
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@165516
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@166205
      * Returns the index of the first element in the array where predicate is true, and -1
      * otherwise.
     */
    public native Number findIndex(Function3<Number, Number, Array<Number>, Boolean> predicate);
    /** 
      * Std Signature : S(forEach,289,,P(dFP1-,P2-,P3--S(?,289,,P(d3),P(d4),P(d5))------)<2,7,35>))
      * TE Signature : S(forEach,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@166729
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@167126
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@167476
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@229496
    ...
    /** 
      * Std Signature : S(reduce,2,,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<2,8,8,35,8>),P(d2))
      * TE Signature : S(reduce,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@169201
      ...
      * call to the callback function.
     */
    public native Number reduce(Function4<Number, Number, Number, Float32Array, Number> callbackfn, Number initialValue /* optional */);
    /** 
      * Std Signature : S(reduce,U-,U-,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<U-,2,9,35,8>),P(dU-))
      * TE Signature : S(reduce,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@170018
      * Calls the specified callback function for all the elements in an array. The return value of
      * the callback function is the accumulated result, and is provided as an argument in the next
      * call to the callback function.
      * Calls the specified callback function for all the elements in an array. The return value of
      ...
      * VERSION 1
     */
    public native <U> U reduce(Function4<U, Number, Number, Float32Array, U> callbackfn, U initialValue);
    /** 
      * Std Signature : S(reduceRight,2,,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<2,8,8,35,8>))
    ...
    /** 
      * Std Signature : S(reduceRight,2,,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<2,8,8,35,8>),P(d2))
      * TE Signature : S(reduceRight,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@170843
      ...
      * argument in the next call to the callback function.
     */
    public native Number reduceRight(Function4<Number, Number, Number, Float32Array, Number> callbackfn, Number initialValue /* optional */);
    /** 
      * Std Signature : S(reduceRight,U-,U-,P(dFP1-,P2-,P3-,P4-,R--S(?,7,,P(d3),P(d4),P(d5),P(d6))------)<U-,2,9,35,8>),P(dU-))
      * TE Signature : S(reduceRight,P(dF--S(?,P(d3),P(d4),P(d4),P(d4))------)),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@171691
      * Calls the specified callback function for all the elements in an array, in descending order.
      * The return value of the callback function is the accumulated result, and is provided as an
      * argument in the next call to the callback function.
      * Calls the specified callback function for all the elements in an array, in descending order.
      ...
      * VERSION 1
     */
    public native <U> U reduceRight(Function4<U, Number, Number, Float32Array, U> callbackfn, U initialValue);
    /** 
      * Std Signature : S(reverse,35,,)
      * TE Signature : S(reverse,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@171894
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@172079
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@172342
      * Sets a value or an array of values.
      * Sets a value or an array of values.
      * VERSION 1
     */
    ...
    /** 
      * Std Signature : S(slice,35,,)
      * TE Signature : S(slice,)
      * 
     */
    public native Float32Array slice();
    /** 
      * Std Signature : S(slice,35,,P(d2))
      * TE Signature : S(slice,P(d2))
      * 
     */
    public native Float32Array slice(Number start /* optional */);
    /** 
      * Std Signature : S(slice,35,,P(d2),P(d2))
      * TE Signature : S(slice,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@172597
      * Returns a section of an array.
     */
    public native Float32Array slice(Number start /* optional */, Number end /* optional */);
    /** 
      * Std Signature : S(some,27,,P(dFP1-,P2-,P3-,R--S(?,6,,P(d3),P(d4),P(d5))------)<2,7,35,27>))
      * TE Signature : S(some,P(dF--S(?,P(d3),P(d4),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@173164
      * Determines whether the specified callback function returns true for any element of an array.
     */
    public native Boolean some(Function3<Number, Number, Float32Array, Boolean> callbackfn);
    /** 
      * Std Signature : S(sort,35,,)
      * TE Signature : S(sort,)
      * 
     */
    public native Float32Array sort();
    /** 
      * Std Signature : S(sort,35,,P(dFP1-,P2-,R--S(?,5,,P(d3),P(d4))------)<2,6,6>))
      * TE Signature : S(sort,P(dF--S(?,P(d3),P(d4))------)))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@173492
      * Sorts an array.
     */
    public native Float32Array sort(Function2<Number, Number, Number> compareFn /* optional */);
    /** 
      * Std Signature : S(subarray,35,,P(d2))
      * TE Signature : S(subarray,P(d2))
      * 
     */
    public native Float32Array subarray(Number begin);
    /** 
      * Std Signature : S(subarray,35,,P(d2),P(d2))
      * TE Signature : S(subarray,P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@173842
      * Gets a new Float32Array view of the ArrayBuffer store for this array, referencing the elements
      * at begin, inclusive, up to end, exclusive.
     */
    public native Float32Array subarray(Number begin, Number end /* optional */);
    /** 
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@173984
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@229599
