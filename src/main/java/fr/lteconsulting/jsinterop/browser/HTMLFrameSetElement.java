...
/** 
  * base type: HTMLFrameSetElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:415178
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:417508
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLFrameSetElement")
public class HTMLFrameSetElement implements HTMLElement
{
