...
/** 
  * base type: HTMLHtmlElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:419370
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:419825
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLHtmlElement")
public class HTMLHtmlElement implements HTMLElement
{
