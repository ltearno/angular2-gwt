...
/** 
  * base type: SVGRectElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:623471
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:624035
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SVGRectElement")
public class SVGRectElement implements SVGGraphicsElement
{
