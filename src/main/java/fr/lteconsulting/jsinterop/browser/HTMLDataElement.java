...
/** 
  * base type: HTMLDataElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:395799
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:396158
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="HTMLDataElement")
public class HTMLDataElement implements HTMLElement
{
