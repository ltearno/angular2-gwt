...
/** 
  * base type: HTMLVideoElement
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:486842
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:488849
  * 1 constructors
 */
...
public class HTMLVideoElement extends HTMLMediaElement
{
    ...
    */
    ...
    @JsProperty( name = "videoHeight")
    public native void setVideoHeight( Number value );
    ...
    @JsProperty( name = "videoWidth")
    public native void setVideoWidth( Number value );
    ...
    */
    ...
    /** 
      * Std Signature : S(getVideoPlaybackQuality,549,,)
      * TE Signature : S(getVideoPlaybackQuality,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@488133
     */
    ...
    /** 
      * Std Signature : S(msFrameStep,289,,P(d27))
      * TE Signature : S(msFrameStep,P(d27))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@488186
     */
    ...
    /** 
      * Std Signature : S(msInsertVideoEffect,289,,P(d1),P(d27))
      * TE Signature : S(msInsertVideoEffect,P(d1),P(d27))
      * 
     */
    public native void msInsertVideoEffect(String activatableClassId, Boolean effectRequired);
    /** 
      * Std Signature : S(msInsertVideoEffect,289,,P(d1),P(d27),P(d3))
      * TE Signature : S(msInsertVideoEffect,P(d1),P(d27),P(d3))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@488227
     */
    ...
    /** 
      * Std Signature : S(msSetVideoRectangle,289,,P(d2),P(d2),P(d2),P(d2))
      * TE Signature : S(msSetVideoRectangle,P(d2),P(d2),P(d2),P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@488325
     */
    public native void msSetVideoRectangle(Number left, Number top, Number right, Number bottom);
    /** 
    ...
    /** 
      * Std Signature : S(webkitEnterFullScreen,289,,)
      * TE Signature : S(webkitEnterFullScreen,)
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@488414
     */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@488449
     */
    public native void webkitEnterFullscreen();
    /** 
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@488484
     */
     ...
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@488518
     */
    public native void webkitExitFullscreen();
    /** 
