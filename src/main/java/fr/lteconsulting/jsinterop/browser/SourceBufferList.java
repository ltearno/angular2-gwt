...
/** 
  * base type: SourceBufferList
  * flags: 32768
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:645091
  * declared in: apis/browser-api/tsd/lib.es6.d.ts:645259
  * 1 constructors
 */
@JsType(isNative=true, namespace=JsPackage.GLOBAL, name="SourceBufferList")
public class SourceBufferList implements EventTarget
{
    ...
    */
    ...
    /** 
      * Std Signature : S(item,244,,P(d2))
      * TE Signature : S(item,P(d2))
      * 
     */
    /** 
      * apis/browser-api/tsd/lib.es6.d.ts@645175
     */
    public native SourceBuffer item(Number index);
    /** 
