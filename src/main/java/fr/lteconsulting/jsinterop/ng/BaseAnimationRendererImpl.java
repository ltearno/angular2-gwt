...
/** 
  ...
  * 1 constructors
 */
@JsType(isNative=true, namespace="ng", name="BaseAnimationRenderer")
public class BaseAnimationRendererImpl implements BaseAnimationRenderer
{

    /*
        Constructors
    */
    public BaseAnimationRendererImpl(String namespaceId, Renderer2 delegate, AnimationEngine engine){
    }
