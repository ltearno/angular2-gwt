...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/forms/src/directives/reactive_directives/form_control_directive".FormControlDirective
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/forms/src/directives/reactive_directives/form_control_directive.d.ts:562
  * 1 constructors
 */
@JsType(isNative=true, namespace="ng.forms", name="FormControlDirective")
public class FormControlDirective extends NgControl implements OnChanges
{

    /*
        Constructors
    */
    public FormControlDirective(Array<UnionOfValidatorAndValidatorFn> validators, Array<UnionOfAsyncValidatorAndAsyncValidatorFn> asyncValidators, Array<ControlValueAccessor> valueAccessors){
    }
    ...
    */
    ...
    public native FormControl getForm();

    @JsProperty( name = "form")
    public native void setForm( FormControl value );
    ...
    */
    /** 
      * Std Signature : S(_isControlChanged,3,,P(d3))
      * TE Signature : S(_isControlChanged,P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/forms/src/directives/reactive_directives/form_control_directive.d.ts@3100
     */
    public native Object _isControlChanged(Object changes);
    /** 
