...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/forms/src/directives/ng_control".NgControl
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/forms/src/directives/ng_control.d.ts:402
...
public class NgControl implements AbstractControlDirective
{
    ...
    */
    ...
    public ControlValueAccessor valueAccessor;

    @JsProperty( name = "valueAccessor")
    public native ControlValueAccessor getValueAccessor();

    @JsProperty( name = "valueAccessor")
    public native void setValueAccessor( ControlValueAccessor value );
    ...
    */
    ...
    /** 
      * Std Signature : S(viewToModelUpdate,429,,P(d3))
      * TE Signature : S(viewToModelUpdate,P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/forms/src/directives/ng_control.d.ts@825
     */
