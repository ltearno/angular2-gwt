...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/forms/src/directives/validators".MinLengthValidator
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/forms/src/directives/validators.d.ts:3459

  * A directive which installs the {@link MinLengthValidator} for any `formControlName`,
  * `formControl`, or control with `ngModel` that also has a `minlength` attribute.
 */
@JsType(isNative=true, namespace="ng.forms", name="MinLengthValidator")
public class MinLengthValidator extends Validator implements OnChanges
{
    ...
    */
    ...
    public native String getMinlength();

    @JsProperty( name = "minlength")
    public native void setMinlength( String value );
    ...
    */
     ...
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/forms/src/directives/validators.d.ts@3960
     */
