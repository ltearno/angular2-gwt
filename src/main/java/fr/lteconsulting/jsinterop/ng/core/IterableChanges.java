...
public interface IterableChanges<V>
{
    ...
    */
     ...
     */
    void forEachAddedItem(Action1<IterableChangeRecord<V>> fn);
    /** 
     ...
     */
    void forEachIdentityChange(Action1<IterableChangeRecord<V>> fn);
    /** 
    ...
    /** 
      ...
      * to each item.
     */
    void forEachItem(Action1<IterableChangeRecord<V>> fn);
    /** 
     ...
     */
    void forEachMovedItem(Action1<IterableChangeRecord<V>> fn);
    /** 
    ...
    /** 
      ...
      * ones applied.
     */
    void forEachOperation(Action3<IterableChangeRecord<V>, Number, Number> fn);
    /** 
    ...
    /** 
      ...
      * have moved.
     */
    void forEachPreviousItem(Action1<IterableChangeRecord<V>> fn);
    /** 
     ...
     */
    void forEachRemovedItem(Action1<IterableChangeRecord<V>> fn);
}
