...
import fr.lteconsulting.jsinterop.rxjs.ConnectableObservable;
import fr.lteconsulting.jsinterop.rxjs.ErrorObserver;
import fr.lteconsulting.jsinterop.rxjs.GroupedObservable;
import fr.lteconsulting.jsinterop.rxjs.IScheduler;
import fr.lteconsulting.jsinterop.rxjs.NextObserver;
import fr.lteconsulting.jsinterop.rxjs.Notification;
import fr.lteconsulting.jsinterop.rxjs.Observable;
import fr.lteconsulting.jsinterop.rxjs.Operator;
import fr.lteconsulting.jsinterop.rxjs.PartialObserver_UnionOfCompletionObserverOfTAndErrorObserverOfTAndNextObserverOfT;
import fr.lteconsulting.jsinterop.rxjs.Subject;
import fr.lteconsulting.jsinterop.rxjs.Subscribable;
import fr.lteconsulting.jsinterop.rxjs.Subscriber;
import fr.lteconsulting.jsinterop.rxjs.Subscription;
import fr.lteconsulting.jsinterop.rxjs.ThrottleConfig;
import fr.lteconsulting.jsinterop.rxjs.TimeInterval;
import fr.lteconsulting.jsinterop.rxjs.Timestamp;
import fr.lteconsulting.jsinterop.rxjs.UnionOfISchedulerAndT;
...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/core/src/event_emitter".EventEmitter
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/core/src/event_emitter.d.ts:242
  * 1 constructors
...
public class EventEmitter<T> extends Subject<T>
{
    ...
    */
    ...
    public native Boolean get___isAsync();

    @JsProperty( name = "___isAsync")
    public native void set___isAsync( Boolean value );
    ...
    */
    ...
    /** 
      * Std Signature : S(emit,429,,)
      * TE Signature : S(emit,)
      * 
     */
    public native void emit();
    /** 
      * Std Signature : S(emit,429,,P(dT-))
      * TE Signature : S(emit,P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/core/src/event_emitter.d.ts@1893
     */
    public native void emit(T value /* optional */);
    /** 
    ...
    /** 
      * Std Signature : S(subscribe,3,,P(d3))
      * TE Signature : S(subscribe,P(d3))
      * 
     */
    public native Object subscribe(Object generatorOrNext /* optional */);
    /** 
      * Std Signature : S(subscribe,3,,P(d3),P(d3))
      * TE Signature : S(subscribe,P(d3),P(d3))
      * 
     */
    public native Object subscribe(Object generatorOrNext /* optional */, Object error /* optional */);
    /** 
      * Std Signature : S(subscribe,3,,P(d3),P(d3),P(d3))
      * TE Signature : S(subscribe,P(d3),P(d3),P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/core/src/event_emitter.d.ts@1920
     */
    public native Object subscribe(Object generatorOrNext /* optional */, Object error /* optional */, Object complete /* optional */);
    /** 
