...
public interface IterableDiffer<V>
{
    ...
    */
    /** 
      ...
      * 
     */
    IterableChanges<V> diff(Iterable<V> object);
    /** 
      * Std Signature : S(diff,1197<V->,,P(d7<V->))
      * TE Signature : S(diff,P(d7))
      * 
     */
    IterableChanges<V> diff(Array<V> object);
    /** 
     ...
     */
    IterableChanges<V> diff(NgIterable_UnionOfArrayOfVAndIterableOfV<V> object);
}
