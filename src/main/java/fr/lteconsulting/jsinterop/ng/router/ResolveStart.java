...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/router/src/events".ResolveStart
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/router/src/events.d.ts:4746
  * 1 constructors
 */
@JsType(isNative=true, namespace="ng.router", name="ResolveStart")
public class ResolveStart
{

    /*
        Constructors
    */
    public ResolveStart(Number id, String url, String urlAfterRedirects, RouterStateSnapshot state){
    }
