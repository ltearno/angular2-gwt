...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/compiler/src/output/output_ast".RecursiveAstVisitor
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/compiler/src/output/output_ast.d.ts:19882
  * 
 */
@JsType(isNative=true, namespace="ng.compiler.output", name="RecursiveAstVisitor")
public class RecursiveAstVisitor implements StatementVisitor, ExpressionVisitor
{
    ...
    */
    /** 
      * Std Signature : S(visitAllExpressions,429,,P(d7<449>),P(d3))
      * TE Signature : S(visitAllExpressions,P(d7),P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/compiler/src/output/output_ast.d.ts@21234
     */
    public native void visitAllExpressions(Array<Expression> exprs, Object context);
    /** 
      * Std Signature : S(visitAllStatements,429,,P(d7<488>),P(d3))
      * TE Signature : S(visitAllStatements,P(d7),P(d3))
      * 
     */
    /** 
      * c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/compiler/src/output/output_ast.d.ts@21867
     */
    public native void visitAllStatements(Array<Statement> stmts, Object context);
    /** 
