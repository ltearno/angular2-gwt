...
/** 
  * base type: "c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/compiler/src/compile_metadata".CompileDirectiveSummary
  * flags: 32768
  * declared in: c:/Documents/Repos/typescript2java/apis/angular4-api/tsd/@angular/compiler/src/compile_metadata.d.ts:7004
  * 
 */
@JsType(isNative=true, namespace="ng.compiler", name="CompileDirectiveSummary")
public class CompileDirectiveSummary extends CompileTypeSummary
{
    ...
    */
    ...
    public native CompileTemplateSummary getTemplate();

    @JsProperty( name = "template")
    public native void setTemplate( CompileTemplateSummary value );
