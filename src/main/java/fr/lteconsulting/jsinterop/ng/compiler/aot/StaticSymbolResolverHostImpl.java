 ...
 */
@JsType(isNative=true, namespace="ng.compiler.aot", name="StaticSymbolResolverHost")
public class StaticSymbolResolverHostImpl implements StaticSymbolResolverHost
{
